...
public class PermissionStorage {
    ...
    public HashMap<Principal, List<OpenSearchPermission>> permissionStore = new HashMap<>();
     ...
     */
    public void put(Principal principal, List<OpenSearchPermission> permissions) {
     ...
     */
    public List<OpenSearchPermission> get(Principal principal) {
     ...
     */
    public void delete(Principal principal, List<OpenSearchPermission> permissions) {
