...
public interface QueryPlanExecutor<LogicalPlan, Stream> {
     ...
     */
    void execute(LogicalPlan plan, QueryEngineContext queryCtx, ActionListener<Stream> listener);
     ...
     */
    default void executeWithProfile(LogicalPlan plan, QueryEngineContext queryCtx, ActionListener<ProfiledResult> listener) {
