...
public class LuceneFieldRegistryTests extends OpenSearchTestCase {
    ...
    public void testAllCoreDataFieldsRegistered() {
        ...
        for (String type : expectedTypes) {
            assertNotNull("Missing registration for: " + type, LuceneFieldRegistry.getLuceneField(type));
        }
    }
    ...
    public void testUnknownFieldTypeReturnsNull() {
        assertNull(LuceneFieldRegistry.getLuceneField("nonexistent_type"));
    }

    public void testGetRegisteredFieldsIsUnmodifiable() {
        Map<String, LuceneField> fields = LuceneFieldRegistry.getRegisteredFields();
