...
/**
 * Lucene field for 16-bit signed short values.
 * Delegates to the same Lucene field types as INTEGER. Conditionally adds an {@link IntPoint}
...
public class ShortLuceneField extends LuceneField {
    ...
    /** Creates a new ShortLuceneField. */
    public ShortLuceneField() {}
