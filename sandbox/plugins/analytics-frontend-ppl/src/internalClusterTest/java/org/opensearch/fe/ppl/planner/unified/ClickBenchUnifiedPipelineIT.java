...
package org.opensearch.fe.ppl.planner.unified;
...
import org.opensearch.fe.ppl.PPLFrontEndPlugin;
 ...
 *
 * <p>Spawns a real cluster with PPLFrontEndPlugin + the real AnalyticsEnginePlugin
...
public class ClickBenchUnifiedPipelineIT extends OpenSearchIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return List.of(PPLFrontEndPlugin.class, FlightStreamPlugin.class, MockQueryEnginePlugin.class);
    }

    /**
     * Minimal mock of {@link QueryEnginePlugin} that provides a no-op {@link QueryPlanExecutor}
     * returning empty results. Allows the unified pipeline to wire up without the real engine module.
     */
    public static class MockQueryEnginePlugin extends Plugin implements QueryEnginePlugin {
        ...
        public Collection<Object> createComponents(
            ...
            this.executor = (plan, context) -> new ArrayList<>();
