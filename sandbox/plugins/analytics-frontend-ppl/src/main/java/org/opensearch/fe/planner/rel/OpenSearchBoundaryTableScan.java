...
package org.opensearch.fe.planner.rel;
 ...
 * {@code execute()} passes the fragment to the {@link PlanExecutor}, which
...
public class OpenSearchBoundaryTableScan extends TableScan implements EnumerableRel {
    ...
    public PlanExecutor getEngineExecutor() {
        return planExecutor;
    }
    ...
    /**
     * Executes the logical fragment via the {@link PlanExecutor}.
     *
    ...
    public Enumerable<Object[]> bind(DataContext dataContext) {
        try {
            return planExecutor.execute(logicalFragment, dataContext);
        } catch (Exception e) {
