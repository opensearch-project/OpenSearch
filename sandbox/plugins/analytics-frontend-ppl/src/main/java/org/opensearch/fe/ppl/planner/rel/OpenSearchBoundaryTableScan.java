...
package org.opensearch.fe.ppl.planner.rel;
 ...
 * {@code execute()} passes the fragment to the {@link EngineExecutor}, which
...
public class OpenSearchBoundaryTableScan extends TableScan implements EnumerableRel {
    ...
    /**
     * Executes the logical fragment via the {@link EngineExecutor}.
     *
    ...
    public Enumerable<Object[]> bind(DataContext dataContext) {
        try {
            return engineExecutor.execute(logicalFragment, dataContext);
        } catch (Exception e) {
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
        return new OpenSearchBoundaryTableScan(getCluster(), traitSet, getTable(), logicalFragment, engineExecutor);
    }
