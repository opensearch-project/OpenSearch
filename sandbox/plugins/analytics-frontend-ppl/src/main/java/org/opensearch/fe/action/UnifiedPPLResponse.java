 ...
 */
public class UnifiedPPLResponse extends ActionResponse {

    private final List<String> columns;
    private final List<Object[]> rows;

    public UnifiedPPLResponse(List<String> columns, List<Object[]> rows) {
        this.columns = columns;
        this.rows = rows;
    }

    public UnifiedPPLResponse(StreamInput in) throws IOException {
        super(in);
