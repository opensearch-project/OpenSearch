 ...
 * Registered as a transport action in PPLFrontEndPlugin.
 */
public class UnifiedPPLExecuteAction extends ActionType<UnifiedPPLResponse> {
    ...
    private UnifiedPPLExecuteAction() {
        super(NAME, UnifiedPPLResponse::new);
    }
}
