...
/// Must be a power of two (upstream default).
...
impl LiquidOnlyRuntime {
    ...
    pub fn reset_cache(&self) {
        // Concurrent queries may observe a cold cache; benign for a read-through cache.
    ...
    /// Counter snapshot for the stats FFI, or `None` when uninitialized. Order:
