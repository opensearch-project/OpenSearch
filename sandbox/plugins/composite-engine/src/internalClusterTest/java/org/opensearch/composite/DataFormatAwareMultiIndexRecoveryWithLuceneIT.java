...
/**
 * Runs all multi-index recovery tests from {@link DataFormatAwareMultiIndexRecoveryIT} with
 * Lucene as a secondary data format alongside Parquet.
 */
@OpenSearchIntegTestCase.ClusterScope(scope = OpenSearchIntegTestCase.Scope.TEST, numDataNodes = 0)
public class DataFormatAwareMultiIndexRecoveryWithLuceneIT extends DataFormatAwareMultiIndexRecoveryIT {
