...
/**
 * Runs all peer recovery tests from {@link DataFormatAwarePeerRecoveryIT} with Lucene as a
 * secondary data format alongside Parquet.
 */
@OpenSearchIntegTestCase.ClusterScope(scope = OpenSearchIntegTestCase.Scope.TEST, numDataNodes = 0)
public class DataFormatAwarePeerRecoveryWithLuceneIT extends DataFormatAwarePeerRecoveryIT {
