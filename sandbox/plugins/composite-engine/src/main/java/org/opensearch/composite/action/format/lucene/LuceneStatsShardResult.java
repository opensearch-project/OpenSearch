 ...
 */
@ExperimentalApi
public class LuceneStatsShardResult implements Writeable {

    private final ShardRouting shardRouting;
    private final BytesReference statsJsonBytes;

    public LuceneStatsShardResult(ShardRouting shardRouting, org.opensearch.core.xcontent.ToXContentFragment stats) throws IOException {
    ...
    public LuceneStatsShardResult(StreamInput in) throws IOException {
