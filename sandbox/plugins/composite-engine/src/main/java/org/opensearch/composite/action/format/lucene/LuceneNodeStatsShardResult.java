...
/**
 * Per-shard result containing the shard routing and pre-rendered Lucene stats JSON bytes.
 ...
 */
@ExperimentalApi
public class LuceneNodeStatsShardResult implements Writeable {

    private final ShardRouting shardRouting;
    private final BytesReference statsJsonBytes;

    public LuceneNodeStatsShardResult(ShardRouting shardRouting, org.opensearch.core.xcontent.ToXContentFragment stats) throws IOException {
    ...
    public LuceneNodeStatsShardResult(StreamInput in) throws IOException {
