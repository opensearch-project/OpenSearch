...
/**
 * Request for catalog snapshot using broadcast-by-node routing.
 *
 * @opensearch.experimental
 */
@ExperimentalApi
public class CatalogSnapshotRequest extends BroadcastRequest<CatalogSnapshotRequest> {

    private final boolean shardLevel;
    private final Integer shardFilter;
    private final String nodeFilter;

    public CatalogSnapshotRequest(String index, boolean shardLevel, Integer shardFilter, String nodeFilter) {
        super(index);
    ...
    public CatalogSnapshotRequest(StreamInput in) throws IOException {
        super(in);
