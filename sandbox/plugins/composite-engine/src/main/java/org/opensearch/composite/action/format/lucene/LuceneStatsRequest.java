...
/**
 * Request for Lucene index-level stats using broadcast-by-node routing.
 *
 * @opensearch.experimental
 */
@ExperimentalApi
public class LuceneStatsRequest extends BroadcastRequest<LuceneStatsRequest> {

    private final boolean shardLevel;
    private final Integer shardFilter;
    private final String nodeFilter;

    public LuceneStatsRequest(String index, boolean shardLevel, Integer shardFilter, String nodeFilter) {
        super(index);
    ...
    public LuceneStatsRequest(StreamInput in) throws IOException {
        super(in);
