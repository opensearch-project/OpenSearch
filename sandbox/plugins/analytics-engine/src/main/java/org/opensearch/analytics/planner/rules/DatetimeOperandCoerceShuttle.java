 ...
 *
 * <p>Not safe to share across concurrent planning runs: {@code RelShuttleImpl}
 * carries a {@code Deque<RelNode>} traversal stack that is mutated during
 * {@code visit}. Callers must instantiate a fresh shuttle per
 * {@code PlannerImpl.runAllOptimizations} invocation.
 *
 * @opensearch.internal
 */
public final class DatetimeOperandCoerceShuttle extends RelHomogeneousShuttle {
    ...
    public DatetimeOperandCoerceShuttle() {}
