...
public class SpillStatsTests extends OpenSearchTestCase {
    ...
    public void testRoundTripSerializationPreservesAllFields() throws Exception {
        SpillStats original = new SpillStats(
            "/mnt/spill",
            536_870_912_000L,
            214_748_364_800L,
            1_073_741_824L,
    ...
    public void testToXContentEmitsSpillObjectWithFiveFields() throws Exception {
        SpillStats stats = new SpillStats(
            "/mnt/spill",
            536_870_912_000L,
            214_748_364_800L,
            1_073_741_824L,
    ...
    public void testDisabledStateIsRepresentableWithEmptyDirectoryAndZeroBytes() throws Exception {
