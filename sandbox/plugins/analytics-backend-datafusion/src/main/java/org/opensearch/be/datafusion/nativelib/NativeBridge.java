...
public final class NativeBridge {
    ...
    public static long getMemoryPoolUsage(long runtimePtr) {
        try {
            ...
            throw new RuntimeException("Failed to get memory pool usage", t);
        }
    }
    ...
    public static long getMemoryPoolLimit(long runtimePtr) {
        try {
            return (long) GET_MEMORY_POOL_LIMIT.invokeExact(runtimePtr);
        } catch (Throwable t) {
            throw new RuntimeException("Failed to get memory pool limit", t);
        }
    }
    ...
    public static void setMemoryPoolLimit(long runtimePtr, long newLimitBytes) {
        try {
            SET_MEMORY_POOL_LIMIT.invokeExact(runtimePtr, newLimitBytes);
        } catch (Throwable t) {
            throw new RuntimeException("Failed to set memory pool limit", t);
        }
    }
