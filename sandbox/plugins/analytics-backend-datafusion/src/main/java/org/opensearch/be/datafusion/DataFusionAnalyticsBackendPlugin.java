        ...
        return new BackendCapabilityProvider() {
            ...
            public Map<ScalarFunction, ScalarFunctionAdapter> scalarFunctionAdapters() {
                ...
                return Map.ofEntries(
                    ...
                    Map.entry(ScalarFunction.NUM, new ConversionFunctionAdapter(ConversionFunctionAdapter.NUM)),
                    Map.entry(ScalarFunction.AUTO, new ConversionFunctionAdapter(ConversionFunctionAdapter.AUTO)),
                    Map.entry(ScalarFunction.MEMK, new ConversionFunctionAdapter(ConversionFunctionAdapter.MEMK)),
                    Map.entry(ScalarFunction.RMCOMMA, new ConversionFunctionAdapter(ConversionFunctionAdapter.RMCOMMA)),
                    Map.entry(ScalarFunction.RMUNIT, new ConversionFunctionAdapter(ConversionFunctionAdapter.RMUNIT)),
                    Map.entry(ScalarFunction.DUR2SEC, new ConversionFunctionAdapter(ConversionFunctionAdapter.DUR2SEC)),
                    Map.entry(ScalarFunction.MSTIME, new ConversionFunctionAdapter(ConversionFunctionAdapter.MSTIME)),
