...
public class TransportDslValidateActionTests extends OpenSearchTestCase {
    ...
    public void testMultipleConcreteIndicesFails() {
        TransportDslValidateAction action = createAction(new Index("index-a", "uuid-a"), new Index("index-b", "uuid-b"));
    ...
    public void testIndexNotInSchemaFails() {
        TransportDslValidateAction action = createAction(new Index("nonexistent-index", "uuid"));
    ...
    private TestListener validate(QueryBuilder query, boolean explain) {
        TransportDslValidateAction action = createAction(new Index("test-index", "uuid"));
    ...
    private TransportDslValidateAction createAction(Index... resolvedIndices) {
        ...
        return new TransportDslValidateAction(
