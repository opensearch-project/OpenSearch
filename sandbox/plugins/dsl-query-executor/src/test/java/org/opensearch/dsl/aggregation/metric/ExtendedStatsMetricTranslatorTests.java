...
public class ExtendedStatsMetricTranslatorTests extends OpenSearchTestCase {
    ...
    private final ExtendedStatsMetricTranslator translator = new ExtendedStatsMetricTranslator(MAPPER);
    ...
    public void testScriptRejected() {
        ExtendedStatsAggregationBuilder agg = new ExtendedStatsAggregationBuilder("price_stats").script(new Script("doc['price'].value"));
