...
public class AggregationTreeWalkerTests extends OpenSearchTestCase {
    ...
    public void testSiblingFilterBucketsProduceSeparatePlans() throws ConversionException {
        List<AggregationBuilder> aggs = List.of(
            new FilterAggregationBuilder("active", new TermQueryBuilder("brand", "alpha")).subAggregation(
                new AvgAggregationBuilder("avg_price").field("price")
            ),
            new FilterAggregationBuilder("premium", new TermQueryBuilder("brand", "beta")).subAggregation(
                new SumAggregationBuilder("total_price").field("price")
            )
        );
    ...
    public void testFilterBucketAlongsideUnfilteredMetric() throws ConversionException {
        List<AggregationBuilder> aggs = List.of(
            new AvgAggregationBuilder("global_avg").field("price"),
            new FilterAggregationBuilder("active", new TermQueryBuilder("brand", "test")).subAggregation(
                new AvgAggregationBuilder("filtered_avg").field("price")
            )
        );
    ...
    public void testMultipleFilterBucketsWithUnfilteredMetrics() throws ConversionException {
        List<AggregationBuilder> aggs = List.of(
            ...
            new FilterAggregationBuilder("filter_a", new TermQueryBuilder("brand", "alpha")).subAggregation(
                new AvgAggregationBuilder("a_avg").field("price")
            ),
            new FilterAggregationBuilder("filter_b", new TermQueryBuilder("brand", "beta")).subAggregation(
                new SumAggregationBuilder("b_sum").field("price")
            )
        );
    ...
    public void testFiltersBucketWithOtherBucket() throws ConversionException {
        List<AggregationBuilder> aggs = List.of(
            ...
            ).otherBucket(true).otherBucketKey("other_brands").subAggregation(new AvgAggregationBuilder("avg_price").field("price"))
        );
    ...
    public void testFiltersBucketWithoutOtherBucket() throws ConversionException {
        List<AggregationBuilder> aggs = List.of(
            ...
            ).otherBucket(false).subAggregation(new SumAggregationBuilder("total").field("price"))
        );
    ...
    public void testFiltersBucketAlongsideSiblingMetric() throws ConversionException {
        ...
        AggregationMetadata unfiltered = result.stream().filter(m -> m.getFilterCondition() == null).findFirst().orElseThrow();
    ...
    public void testFiltersBucketUnderTermsBucket() throws ConversionException {
        ...
        List<AggregationMetadata> filtered = result.stream().filter(m -> m.getFilterCondition() != null).toList();
    ...
    public void testFiltersBucketAnonymousFiltersUsePositionalKeys() throws ConversionException {
        List<AggregationBuilder> aggs = List.of(
            new FiltersAggregationBuilder("anon", new TermQueryBuilder("brand", "a"), new TermQueryBuilder("brand", "b")).subAggregation(
                new AvgAggregationBuilder("avg").field("price")
            )
        );
    ...
    public void testBuildBucketGranularityKeyWithGroupingsNoSubKey() {
        ...
        assertEquals("0:brand|__filter__active", key);
    }
    ...
    public void testBuildBucketGranularityKeyWithGroupingsAndSubKey() {
        ...
        assertEquals("0:brand|__filter__messages/errors", key);
    }
    ...
    public void testBuildBucketGranularityKeyMultipleGroupings() {
        ...
        assertEquals("0:brand|1:name|__filter__status/active", key);
    }
    ...
    public void testBuildBucketGranularityKeyEmptyGroupingContribution() {
        ...
        assertEquals("0:|__filter__messages/errors", key);
    }
}
