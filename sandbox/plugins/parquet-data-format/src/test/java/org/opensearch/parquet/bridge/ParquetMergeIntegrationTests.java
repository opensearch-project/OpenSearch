...
public class ParquetMergeIntegrationTests extends OpenSearchTestCase {
    ...
    public void testMergeSortedFiles() throws Exception {
        ...
        RustBridge.mergeParquetFilesInRust(List.of(Path.of(file1), Path.of(file2), Path.of(file3)), mergedFile, INDEX_NAME, 0L, 0L);
    ...
    public void testMergeWithInterleavedTimestamps() throws Exception {
        ...
        String mergedFile = tempDir.resolve("merged.parquet").toString();
        RustBridge.mergeParquetFilesInRust(List.of(Path.of(file1), Path.of(file2)), mergedFile, INDEX_NAME, 0L, 0L);
    ...
    public void testMergeSingleFile() throws Exception {
        ...
        String mergedFile = tempDir.resolve("merged.parquet").toString();
        RustBridge.mergeParquetFilesInRust(List.of(Path.of(file1)), mergedFile, INDEX_NAME, 0L, 0L);
