...
public class ParquetMergeIntegrationTests extends OpenSearchTestCase {
    ...
    public void testMergeSortedFiles() throws Exception {
        ...
        RustBridge.mergeParquetFilesInRust(List.of(Path.of(file1), Path.of(file2), Path.of(file3)), null, mergedFile, INDEX_NAME);
    ...
    public void testMergeWithInterleavedTimestamps() throws Exception {
        ...
        String mergedFile = tempDir.resolve("merged.parquet").toString();
        RustBridge.mergeParquetFilesInRust(List.of(Path.of(file1), Path.of(file2)), null, mergedFile, INDEX_NAME);
    ...
    public void testMergeSingleFile() throws Exception {
        ...
        String mergedFile = tempDir.resolve("merged.parquet").toString();
        RustBridge.mergeParquetFilesInRust(List.of(Path.of(file1)), null, mergedFile, INDEX_NAME);
