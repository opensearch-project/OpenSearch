...
public class LateMaterializationDateNanosIT extends AnalyticsRestTestCase {
    ...
    /**
     * Single-shard QTF: no ExchangeReducer, so the query phase is one SHARD_FRAGMENT and the LM stage
     * fetches {@code body} by {@code ___row_id} from that same shard. Same contract as multi-shard.
     */
