...
public class ConditionalFunctionsIT extends AnalyticsRestTestCase {
    ...
    //       sandbox extension catalog) → DataFusion SimplifyExpressions folds now()
    //       against query_execution_start_time → native timestamp comparison.
    //
    // The {@code datetime0} column on the calcs fixture covers
    // 2004-07-04T22:49:28Z..2004-08-02T07:59:23Z (17 rows).
