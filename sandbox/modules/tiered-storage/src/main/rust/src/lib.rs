...
//!
//! Remote store backends (S3, GCS, Azure, FS) live in the separate
//! [`opensearch_remote_store`] crate under `sandbox/libs/remote-store/`.
...
pub use opensearch_remote_store;
