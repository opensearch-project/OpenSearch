...
public class DeleteUserResponse extends ActionResponse implements StatusToXContentObject {
    ...
    private final List<DeleteUserResponseInfo> createUserResults;

    public DeleteUserResponse(List<DeleteUserResponseInfo> createUserResults) {
    ...
    public DeleteUserResponse(StreamInput in) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            createUserResults.add(new DeleteUserResponseInfo(in));
        }

    }

    public List<DeleteUserResponseInfo> getCreateUserResults() {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        for (DeleteUserResponseInfo createUserResults : createUserResults) {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        for (DeleteUserResponseInfo response : createUserResults) {
