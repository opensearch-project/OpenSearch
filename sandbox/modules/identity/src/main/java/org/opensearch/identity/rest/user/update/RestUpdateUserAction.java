 ...
 */
public class RestUpdateUserAction extends BaseRestHandler {
    ...
    public RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        UpdateUserRequest createUserRequest = new UpdateUserRequest(username, password);
        ...
        return channel -> client.doExecute(UpdateUserAction.INSTANCE, createUserRequest, new RestStatusToXContentListener<>(channel));
    }
