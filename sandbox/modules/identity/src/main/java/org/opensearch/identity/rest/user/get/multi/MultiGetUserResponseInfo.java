 ...
 * Returns o
 */
public class MultiGetUserResponseInfo extends TransportResponse implements Writeable, ToXContent {
    private final String username;
    private final Map<String, String> attributes;
    private final List<String> permissions;

    public MultiGetUserResponseInfo(String username, Map<String, String> attributes, List<String> permissions) {
        this.attributes = attributes;
        this.permissions = permissions;
        this.username = username;
    }

    public MultiGetUserResponseInfo(StreamInput in) throws IOException {
        super(in);
