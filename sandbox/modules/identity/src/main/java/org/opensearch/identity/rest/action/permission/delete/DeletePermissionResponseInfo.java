...
public class DeletePermissionResponseInfo extends TransportResponse implements Writeable, ToXContent {
    ...
    public DeletePermissionResponseInfo(boolean successful, String permissionString, String principalString) {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(PRINCIPAL_STRING.getPreferredName(), principalString);
        builder.endObject();
        return builder;
    }
}
