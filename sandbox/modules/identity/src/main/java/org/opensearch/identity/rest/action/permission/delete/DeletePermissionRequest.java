...
public class DeletePermissionRequest extends ActionRequest implements ToXContentObject {
    ...
    public DeletePermissionRequest(String permissionString, String principalString) {
    ...
    public ActionRequestValidationException validate() {
        ...
        if (this.permissionString == null) { // TODO: check the condition once
            validationException = addValidationError("No permissionString specified", validationException);
        } else if (this.principalString == null) {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, ToXContent.Params params) throws IOException {
        builder.startObject();
        builder.value(this.permissionString);
        builder.value(this.principalString);
        builder.endObject();
        return builder;
    }
