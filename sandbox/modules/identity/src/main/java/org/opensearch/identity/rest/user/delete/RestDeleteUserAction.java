...
public class RestDeleteUserAction extends BaseRestHandler {
    ...
    public RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        DeleteUserRequest createUserRequest = new DeleteUserRequest(username, password);
        ...
        return channel -> client.doExecute(DeleteUserAction.INSTANCE, createUserRequest, new RestStatusToXContentListener<>(channel));
    }
