...
public class DataFusionPluginStats implements PluginStats {
    ...
    public static DataFusionPluginStats decode(byte[] bytes) {
        try {
            ...
            return new DataFusionPluginStats(ioRuntime, cpuRuntime, queryExecution, streamNext, fetchPhase, segmentStats);
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ioRuntime, cpuRuntime, queryExecution, streamNext, fetchPhase, segmentStats);
    }
