...
public class MappingMetadataModelTests extends OpenSearchTestCase {
    ...
    public void testEquals() {
        ...
        MappingMetadataModel model2 = new MappingMetadataModel(
            model1.type(),
            model1.source(),
            model1.routingRequired()
        );
    ...
    private static MappingMetadataModel createTestItem() {
        return new MappingMetadataModel(
    ...
    private static CompressedData createTestSource() {
        return new CompressedData(
            randomByteArrayOfLength(randomIntBetween(10, 100)),
            randomInt()
        );
    }
}
