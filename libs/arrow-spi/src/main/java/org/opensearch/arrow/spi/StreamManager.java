...
public interface StreamManager extends AutoCloseable {
     ...
     */
    <Vector, Allocator> StreamTicket registerStream(StreamProducer<Vector, Allocator> producer, TaskId parentTaskId);
     ...
     */
    <Vector> StreamReader<Vector> getStreamReader(StreamTicket ticket);
