...
public class AbstractMappingMetadata extends AbstractDiffable<AbstractMappingMetadata> implements VerifiableWriteable {

    protected final String type;

    protected final CompressedXContent source;

    protected final boolean routingRequired;

    public AbstractMappingMetadata(String type, CompressedXContent mappingSource, Boolean routingRequired) {
        this.type = type;
    ...
    public AbstractMappingMetadata(CompressedXContent mapping) {
        this.source = mapping;
    ...
    @SuppressWarnings("unchecked")
    public AbstractMappingMetadata(String type, Map<String, Object> mapping) {
        this.type = type;
        try {
    ...
    public boolean equals(Object o) {
        ...
        AbstractMappingMetadata that = (AbstractMappingMetadata) o;
    ...
    public AbstractMappingMetadata(StreamInput in) throws IOException {
        type = in.readString();
    ...
    public static Diff<AbstractMappingMetadata> readDiff(StreamInput in) throws IOException {
        return readDiffFrom(AbstractMappingMetadata::new, in);
    }
}
