...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment, VerifiableWriteable {
    ...
    private IndexMetadata(
        ...
        this.isRemoteSnapshot = "remote_snapshot".equals(INDEX_STORE_TYPE_SETTING.get(this.settings));
    ...
    public static class Builder {
        ...
        public MappingMetadata mapping() {
            return mappings.get(Template.SINGLE_MAPPING_NAME);
        }

        public Builder putMapping(String source) throws IOException {
            putMapping(
                new MappingMetadata(
                    Template.SINGLE_MAPPING_NAME,
    ...
    static {
        ...
        params.put(CONTEXT_MODE_PARAM, Metadata.CONTEXT_MODE_GATEWAY);
