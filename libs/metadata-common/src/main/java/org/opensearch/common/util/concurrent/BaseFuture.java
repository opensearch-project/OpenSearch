    ...
    */
    ...
    protected boolean blockingAllowed() {
        return Transports.assertNotTransportThread(BLOCKING_OP_REASON)
            && ThreadUtils.assertNotScheduleThread(BLOCKING_OP_REASON)
            && ThreadUtils.assertNotClusterStateUpdateThread(BLOCKING_OP_REASON)
            && ThreadUtils.assertNotClusterManagerUpdateThread(BLOCKING_OP_REASON);
    }
