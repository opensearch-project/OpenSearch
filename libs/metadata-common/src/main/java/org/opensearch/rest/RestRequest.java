...
public class RestRequest implements ToXContent.Params {
     ...
     * with an unpooled copy. This is supposed to be used before passing requests to org.opensearch.rest.RestHandler
     * instances that can not safely handle http requests that use pooled buffers as determined by
     * org.opensearch.rest.RestHandler#allowsUnsafeBuffers().
     */
     ...
     * org.opensearch.rest.RestHandler treats the {@code source} parameter like the body content.
     */
