...
- Fix allocation and rebalance constraints of weight function getting reset when updating indexBalanceFactor, shardBalanceFactor or preferPrimaryShardRebalanceBuffer ([#15996](https://github.com/opensearch-project/OpenSearch/pull/15996))
