...
public class BlocklistedPathPatternMatcherTests extends OpenSearchTestCase {
    ...
    private void assertMatch(String pattern, String path) {
        BlocklistedPathPatternMatcher matcher = new BlocklistedPathPatternMatcher(pattern);
