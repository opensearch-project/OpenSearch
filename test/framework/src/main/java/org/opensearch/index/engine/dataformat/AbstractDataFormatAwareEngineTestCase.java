...
public abstract class AbstractDataFormatAwareEngineTestCase extends OpenSearchTestCase {
    ...
    /**
     * Creates a mock {@link org.opensearch.index.mapper.MapperService} that returns
     ...
     */
    protected org.opensearch.index.mapper.MapperService createMockMapperService() {
        org.opensearch.index.mapper.MapperService ms = mock(org.opensearch.index.mapper.MapperService.class);
