...
/** An extension of painless which adds a allowlist. */
public class ExampleAllowlistExtension implements PainlessExtension {
    ...
    public Map<ScriptContext<?>, List<Allowlist>> getContextAllowlists() {
        ...
        Allowlist classAllowlist =
                AllowlistLoader.loadFromResourceFiles(ExampleAllowlistExtension.class, parsers, "example_allowlist.txt");

        ExampleAllowlistedInstance ewi = new ExampleAllowlistedInstance(1);
        AllowlistInstanceBinding addValue = new AllowlistInstanceBinding("example addValue", ewi,
            "addValue", "int", Collections.singletonList("int"), Collections.emptyList());
        AllowlistInstanceBinding getValue = new AllowlistInstanceBinding("example getValue", ewi,
            "getValue", "int", Collections.emptyList(), Collections.emptyList());
        Allowlist instanceAllowlist = new Allowlist(ewi.getClass().getClassLoader(), Collections.emptyList(),
