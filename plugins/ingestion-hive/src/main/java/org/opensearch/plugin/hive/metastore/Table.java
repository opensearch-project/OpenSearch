              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list44.size);
                  @org.apache.thrift.annotation.Nullable FieldSchema _elem45;
                  for (int _i46 = 0; _i46 < _list44.size; ++_i46)
                  {
                    _elem45 = new FieldSchema();
                    _elem45.read(iprot);
                    struct.partitionKeys.add(_elem45);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map47.size);
                  ...
                  for (int _i50 = 0; _i50 < _map47.size; ++_i50)
                  {
                    ...
                    struct.parameters.put(_key48, _val49);
                  }
                  iprot.readMapEnd();
                }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Table struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionKeys != null) {
        oprot.writeFieldBegin(PARTITION_KEYS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter51 : struct.partitionKeys)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter52 : struct.parameters.entrySet())
          {
      ...
      if (struct.isSetPartitionKeys()) {
        {
          ...
          for (FieldSchema _iter53 : struct.partitionKeys)
          {
            _iter53.write(oprot);
          }
        }
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter54 : struct.parameters.entrySet())
          {
        ...
        if (incoming.get(7)) {
          {
            ...
            struct.partitionKeys = new java.util.ArrayList<FieldSchema>(_list55.size);
            @org.apache.thrift.annotation.Nullable FieldSchema _elem56;
            for (int _i57 = 0; _i57 < _list55.size; ++_i57)
            {
              _elem56 = new FieldSchema();
              _elem56.read(iprot);
              struct.partitionKeys.add(_elem56);
            }
          }
          struct.setPartitionKeysIsSet(true);
        }
        if (incoming.get(8)) {
          {
            ...
            struct.parameters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map58.size);
            ...
            for (int _i61 = 0; _i61 < _map58.size; ++_i61)
            {
              ...
              struct.parameters.put(_key59, _val60);
            }
          }
          struct.setParametersIsSet(true);
        }
