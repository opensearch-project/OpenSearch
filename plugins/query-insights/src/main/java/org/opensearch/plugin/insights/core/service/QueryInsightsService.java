...
public class QueryInsightsService {
    ...
    private synchronized void checkAndResetWindow(MetricType metricType, Long timestamp) {
        ...
        if (topQueriesWindowStart.get(metricType) < windowStart) {
            ...
            if (topQueriesWindowStart.get(metricType) == windowStart - windowSize.getMillis()) {
            ...
            topQueriesWindowStart.put(metricType, windowStart);
        }
    }
