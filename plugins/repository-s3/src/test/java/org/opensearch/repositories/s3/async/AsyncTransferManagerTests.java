...
public class AsyncTransferManagerTests extends OpenSearchTestCase {
    ...
    public void testMultipartUploadFailsWhenProvideStreamThrowsForOnePart() throws IOException {
        ...
        List<InputStream> streams = new ArrayList<>();
        StreamContext realStreamContext = new StreamContext(
        ...
        doThrow(new IOException("stream context throwing simulated exception for partidx 2"))
            .when(streamContext).provideStream(2);
