...
/**
 * FIPS variant of {@link SecureReactorNetty4HttpServerTransportStreamingTests}.
 * HTTP3/QUIC is disabled because the native quiche library does not use the JVM FIPS provider.
 */
public class SecureReactorNetty4HttpServerTransportStreamingFipsTests extends SecureReactorNetty4HttpServerTransportStreamingTests {
