...
public class DatafusionContext extends SearchContext {
    ...
    /**
     * Sets resultant stream pointer from datafusion
     * @param streamNativePtr Result stream pointer
     */
    public DatafusionContext streamPointer(long streamNativePtr) {
        this.streamNativePtr = streamNativePtr;
        return this;
    }

    /**
     * Returns the resultant stream pointer
     * @return result stream pointer
     */
    public long getStreamNativePtr() {
        return streamNativePtr;
    }
