...
import org.opensearch.plugin.iceberg.catalog.s3.S3ClientSettings.IrsaCredentials;
import org.opensearch.plugin.iceberg.catalog.s3.utils.AwsRequestSigner;
import org.opensearch.plugin.iceberg.catalog.s3.utils.Protocol;
...
class S3Service implements Closeable {
    ...
    S3ClientSettings settings(RepositoryMetadata repositoryMetadata) {
        ...
        final String clientName = S3Settings.CLIENT_NAME.get(settings);
