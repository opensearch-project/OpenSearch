...
public class WorkloadManagementPlugin extends Plugin implements ActionPlugin {
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        return List.of(new ActionPlugin.ActionHandler<>(UpdateQueryGroupAction.INSTANCE, TransportUpdateQueryGroupAction.class));
    }
    ...
    public List<RestHandler> getRestHandlers(
        ...
        return List.of(new RestUpdateQueryGroupAction());
    }
