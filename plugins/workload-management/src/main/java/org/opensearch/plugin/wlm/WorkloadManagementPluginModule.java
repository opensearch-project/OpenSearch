...
import org.opensearch.common.inject.name.Names;
...
public class WorkloadManagementPluginModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(RulePersistenceService.class).annotatedWith(Names.named(WorkloadGroupFeatureType.NAME)).to(IndexStoredRulePersistenceService.class);
    }
}
