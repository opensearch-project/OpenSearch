...
import static org.opensearch.plugin.qg.QueryGroupTestUtils.compareQueryGroups;
import static org.opensearch.plugin.qg.QueryGroupTestUtils.queryGroupList;
import static org.opensearch.plugin.qg.QueryGroupTestUtils.queryGroupOne;
...
public class DeleteQueryGroupResponseTests extends OpenSearchTestCase {
    ...
    public void testSerializationSingleQueryGroup() throws IOException {
        ...
        DeleteQueryGroupResponse response = new DeleteQueryGroupResponse(list);
    ...
    public void testSerializationMultipleQueryGroup() throws IOException {
        DeleteQueryGroupResponse response = new DeleteQueryGroupResponse(queryGroupList());
