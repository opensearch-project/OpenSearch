...
public class UpdateQueryGroupRequest extends ActionRequest implements Writeable.Reader<UpdateQueryGroupRequest> {
     ...
     * @param resourceLimitGroup - A {@link QueryGroup} object
     */
    public UpdateQueryGroupRequest(QueryGroup resourceLimitGroup) {
        this.name = resourceLimitGroup.getName();
        this.mode = resourceLimitGroup.getMode();
        this.resourceLimits = resourceLimitGroup.getResourceLimits();
        this.updatedAtInMillis = resourceLimitGroup.getUpdatedAtInMillis();
        verifyUpdateQueryGroupRequest(name, resourceLimits, updatedAtInMillis);
    }
     ...
     * @param updatedAtInMillis - QueryGroup updated time in millis for UpdateQueryGroupRequest
     */
    private void verifyUpdateQueryGroupRequest(String name, Map<String, Object> resourceLimits, long updatedAtInMillis) {
