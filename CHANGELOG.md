...
- Bump `org.apache.logging.log4j:log4j-core` from 2.25.2 to 2.25.3 ([#20300](https://github.com/opensearch-project/OpenSearch/pull/20300)) ([#20301](https://github.com/opensearch-project/OpenSearch/pull/20301))
