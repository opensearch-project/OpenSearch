...
- Fix request cache entries not being wiped by dynamically updating mapping parameters which can affect queries ([#19346](https://github.com/opensearch-project/OpenSearch/pull/19346))
