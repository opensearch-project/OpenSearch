...
- Created new metadata lib and added model classes for IndexMetadata dependencies like - AliasMetadata, MappingMetadata, Settings etc. ([#20624](https://github.com/opensearch-project/OpenSearch/pull/20624))
