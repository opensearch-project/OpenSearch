...
- Created a new lib metadata-common and separated out AliasMetadata with required dependencies from the server ([#18818](https://github.com/opensearch-project/OpenSearch/pull/18818))
