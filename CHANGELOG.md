...
### Dependencies
- Bump `ch.qos.logback:logback-core` and `ch.qos.logback:logback-classic` from 1.5.24 to 1.5.32 ([#20525](https://github.com/opensearch-project/OpenSearch/pull/20525), [#20637](https://github.com/opensearch-project/OpenSearch/pull/20637))
