...
- Fix swapped field formats in nodes API where `total_indexing_buffer_in_bytes` and `total_indexing_buffer` values were reversed ([#17068](https://github.com/opensearch-project/OpenSearch/pull/17068))
