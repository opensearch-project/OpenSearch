...
- [segment replication] add SEGMENT_COUNTER_INCREMENT_STEP_SETTING and increase default step ([#17568](https://github.com/opensearch-project/OpenSearch/pull/17568))
