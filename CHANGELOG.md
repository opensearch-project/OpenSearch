...
- Bump `com.google.http-client:google-http-client-gson` from 1.43.2 to 1.43.3 in /plugins/repository-gcs ([#8725](https://github.com/opensearch-project/OpenSearch/pull/8725))
