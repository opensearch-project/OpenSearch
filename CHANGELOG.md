...
- Disable scoring of keyword term search by default, allow user use old logic using useSimilarity parameter ([#17889](https://github.com/opensearch-project/OpenSearch/pull/17889))
