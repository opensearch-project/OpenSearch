...
- Add dynamic setting `task_resource_tracking.response_headers.enabled` to control task resource usage in response headers ([#19386](https://github.com/opensearch-project/OpenSearch/pull/19386))
