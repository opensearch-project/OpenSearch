...
- Add Field Mapping correlation metadata ([#7082](https://github.com/opensearch-project/OpenSearch/issues/7082))
...
- Update Field capacity API with the adding the Alias information ([#7082](https://github.com/opensearch-project/OpenSearch/issues/7082))
### Deprecated
