...
- Fix bug for Get Snapshot API to return correct response when getting a non-existing snapshot ([#6839](https://github.com/opensearch-project/OpenSearch/pull/6839))
