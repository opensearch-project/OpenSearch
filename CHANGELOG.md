...
- Throw IllegalArgumentException for resize request without write block (return 4xx instead of 5xx) ([#19026](https://github.com/opensearch-project/OpenSearch/issues/19026))
