...
- Partially resolved issue #4687 by changing the improper status code for concurrent snapshot executions ([#5855](https://github.com/opensearch-project/OpenSearch/pull/5855))
