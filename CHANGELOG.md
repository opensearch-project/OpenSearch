...
- Created a new lib metadata-common and separated out AliasMetadata with required dependencies from the server ([#18844](https://github.com/opensearch-project/OpenSearch/pull/18844))
