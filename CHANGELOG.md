...
- Publish transport-grpc-server-spi enabling plugins to inject custom gRPC BindableServices ([#19304](https://github.com/opensearch-project/OpenSearch/pull/19304))
