...
- Fixed misunderstanding message "No OpenSearchException found" when detailed_error disabled ([#4708](https://github.com/opensearch-project/OpenSearch/pull/4708))
