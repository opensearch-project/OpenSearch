...
- [Segment Replication] Balanced primary shard distribution based allocation and rebalancing constraints ([#6422](https://github.com/opensearch-project/OpenSearch/pull/6422))
