...
- Disable scoring of keyword term search by default, fallback logic with new useSimilarity:true parameter ([#17889](https://github.com/opensearch-project/OpenSearch/pull/17889))
