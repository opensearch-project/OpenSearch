...
- Skip indexing costly fields (e.g., text, BKD) in stale documents to cut memory and performance overhead ([#19056](https://github.com/opensearch-project/OpenSearch/issues/19056))
