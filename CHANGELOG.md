...
- Fixed flaky test failure OperationRoutingTests.testWeightedOperationRoutingWeightUndefinedForOneZone failure([#5289](https://github.com/opensearch-project/OpenSearch/pull/5289))
