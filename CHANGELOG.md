...
- Lazy initialize histogram ranges for filter rewrite optimization to reduce memory and raise bucket limit from 3,000 to 10,000 ([#18241](https://github.com/opensearch-project/OpenSearch/issues/18241))
