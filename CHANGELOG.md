...
- Fix updated keyword field params leading to stale responses from request cache ([#19385](https://github.com/opensearch-project/OpenSearch/pull/19385))- Fix stats API in store-subdirectory module's SubdirectoryAwareStore ([#19469](https://github.com/opensearch-project/OpenSearch/pull/19469))
