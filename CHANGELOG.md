...
- Add new configs to control index throttling, cluster defaults for maxMergeThreads and maxMergeCount ([#19629](https://github.com/opensearch-project/OpenSearch/pull/19629))
### Changed
