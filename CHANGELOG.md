...
- Add a method in IndexNameExpressionResolver to determine if a request matches system indices ([#14415](https://github.com/opensearch-project/OpenSearch/pull/14415))
