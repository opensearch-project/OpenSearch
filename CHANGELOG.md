...
- Implement Visitor Design pattern in QueryBuilder to enable the capability to update the search request. ([#10110](https://github.com/opensearch-project/OpenSearch/pull/10110))
