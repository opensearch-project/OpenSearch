...
public final class RoundingBenchmark_timeUnitRoundingUtcYearOfCenturyJava_jmhTest {
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcYearOfCenturyJava_Throughput(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcYearOfCenturyJava_thrpt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            results.add(
                new ThroughputResult(
                    ResultRole.PRIMARY,
                    "timeUnitRoundingUtcYearOfCenturyJava",
                    res.measuredOps,
                    res.getTime(),
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcYearOfCenturyJava_AverageTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            timeUnitRoundingUtcYearOfCenturyJava_avgt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeUnitRoundingUtcYearOfCenturyJava_avgt_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcYearOfCenturyJava_SampleTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcYearOfCenturyJava_sample_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult((long) res.allOps, (long) res.measuredOps);
            results.add(
                new SampleTimeResult(ResultRole.PRIMARY, "timeUnitRoundingUtcYearOfCenturyJava", buffer, benchmarkParams.getTimeUnit())
            );
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcYearOfCenturyJava_SingleShotTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            timeUnitRoundingUtcYearOfCenturyJava_ss_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeUnitRoundingUtcYearOfCenturyJava_ss_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
