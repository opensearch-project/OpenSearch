...
public final class RoundingBenchmark_timeRoundingDateTimeUnitJoda_jmhTest {
    ...
    public BenchmarkTaskResult timeRoundingDateTimeUnitJoda_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeRoundingDateTimeUnitJoda_thrpt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public BenchmarkTaskResult timeRoundingDateTimeUnitJoda_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            timeRoundingDateTimeUnitJoda_avgt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public BenchmarkTaskResult timeRoundingDateTimeUnitJoda_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeRoundingDateTimeUnitJoda_sample_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeRoundingDateTimeUnitJoda_sample_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult timeRoundingDateTimeUnitJoda_SingleShotTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            timeRoundingDateTimeUnitJoda_ss_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeRoundingDateTimeUnitJoda_ss_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
