...
public final class RoundingBenchmark_timeUnitRoundingUtcDayOfMonthJoda_jmhTest {
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcDayOfMonthJoda_Throughput(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcDayOfMonthJoda_thrpt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            results.add(
                new ThroughputResult(
                    ResultRole.PRIMARY,
                    "timeUnitRoundingUtcDayOfMonthJoda",
                    res.measuredOps,
                    res.getTime(),
    ...
    public static void timeUnitRoundingUtcDayOfMonthJoda_thrpt_jmhStub(
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcDayOfMonthJoda_AverageTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            timeUnitRoundingUtcDayOfMonthJoda_avgt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeUnitRoundingUtcDayOfMonthJoda_avgt_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcDayOfMonthJoda_SampleTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcDayOfMonthJoda_sample_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult((long) res.allOps, (long) res.measuredOps);
            results.add(
                new SampleTimeResult(ResultRole.PRIMARY, "timeUnitRoundingUtcDayOfMonthJoda", buffer, benchmarkParams.getTimeUnit())
            );
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void timeUnitRoundingUtcDayOfMonthJoda_sample_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcDayOfMonthJoda_SingleShotTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            timeUnitRoundingUtcDayOfMonthJoda_ss_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeUnitRoundingUtcDayOfMonthJoda_ss_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
