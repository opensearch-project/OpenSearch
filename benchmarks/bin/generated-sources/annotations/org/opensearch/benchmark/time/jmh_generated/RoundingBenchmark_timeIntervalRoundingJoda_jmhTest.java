...
public final class RoundingBenchmark_timeIntervalRoundingJoda_jmhTest {
    ...
    public BenchmarkTaskResult timeIntervalRoundingJoda_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeIntervalRoundingJoda_thrpt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeIntervalRoundingJoda_thrpt_jmhStub(
    ...
    public BenchmarkTaskResult timeIntervalRoundingJoda_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            timeIntervalRoundingJoda_avgt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeIntervalRoundingJoda_avgt_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult timeIntervalRoundingJoda_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeIntervalRoundingJoda_sample_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public BenchmarkTaskResult timeIntervalRoundingJoda_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            timeIntervalRoundingJoda_ss_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            results.add(
                new SingleShotResult(ResultRole.PRIMARY, "timeIntervalRoundingJoda", res.getTime(), totalOps, benchmarkParams.getTimeUnit())
            );
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void timeIntervalRoundingJoda_ss_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
