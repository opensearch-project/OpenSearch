...
public final class DateFormatterBenchmark_parseJavaDate_jmhTest {
    ...
    public BenchmarkTaskResult parseJavaDate_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            results.add(
                new ThroughputResult(ResultRole.PRIMARY, "parseJavaDate", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit())
            );
    ...
    public static void parseJavaDate_thrpt_jmhStub(
    ...
    public BenchmarkTaskResult parseJavaDate_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult((long) res.allOps, (long) res.measuredOps);
            results.add(
                new AverageTimeResult(ResultRole.PRIMARY, "parseJavaDate", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit())
            );
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void parseJavaDate_sample_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
