...
public final class RoundingBenchmark_timeUnitRoundingUtcQuarterOfYearJoda_jmhTest {
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcQuarterOfYearJoda_Throughput(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcQuarterOfYearJoda_thrpt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            results.add(
                new ThroughputResult(
                    ResultRole.PRIMARY,
                    "timeUnitRoundingUtcQuarterOfYearJoda",
                    res.measuredOps,
                    res.getTime(),
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcQuarterOfYearJoda_AverageTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            timeUnitRoundingUtcQuarterOfYearJoda_avgt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcQuarterOfYearJoda_SampleTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcQuarterOfYearJoda_sample_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult((long) res.allOps, (long) res.measuredOps);
            results.add(
                new SampleTimeResult(ResultRole.PRIMARY, "timeUnitRoundingUtcQuarterOfYearJoda", buffer, benchmarkParams.getTimeUnit())
            );
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void timeUnitRoundingUtcQuarterOfYearJoda_sample_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcQuarterOfYearJoda_SingleShotTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            timeUnitRoundingUtcQuarterOfYearJoda_ss_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeUnitRoundingUtcQuarterOfYearJoda_ss_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
