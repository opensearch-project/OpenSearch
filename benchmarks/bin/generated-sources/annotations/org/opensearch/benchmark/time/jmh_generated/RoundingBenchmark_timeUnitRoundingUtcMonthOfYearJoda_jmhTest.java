...
public final class RoundingBenchmark_timeUnitRoundingUtcMonthOfYearJoda_jmhTest {
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcMonthOfYearJoda_Throughput(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcMonthOfYearJoda_thrpt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            results.add(
                new ThroughputResult(
                    ResultRole.PRIMARY,
                    "timeUnitRoundingUtcMonthOfYearJoda",
                    res.measuredOps,
                    res.getTime(),
    ...
    public static void timeUnitRoundingUtcMonthOfYearJoda_thrpt_jmhStub(
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcMonthOfYearJoda_AverageTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            timeUnitRoundingUtcMonthOfYearJoda_avgt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeUnitRoundingUtcMonthOfYearJoda_avgt_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcMonthOfYearJoda_SampleTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            timeUnitRoundingUtcMonthOfYearJoda_sample_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult((long) res.allOps, (long) res.measuredOps);
            results.add(
                new SampleTimeResult(ResultRole.PRIMARY, "timeUnitRoundingUtcMonthOfYearJoda", buffer, benchmarkParams.getTimeUnit())
            );
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public BenchmarkTaskResult timeUnitRoundingUtcMonthOfYearJoda_SingleShotTime(InfraControl control, ThreadParams threadParams)
        throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams = threadParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            timeUnitRoundingUtcMonthOfYearJoda_ss_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void timeUnitRoundingUtcMonthOfYearJoda_ss_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
