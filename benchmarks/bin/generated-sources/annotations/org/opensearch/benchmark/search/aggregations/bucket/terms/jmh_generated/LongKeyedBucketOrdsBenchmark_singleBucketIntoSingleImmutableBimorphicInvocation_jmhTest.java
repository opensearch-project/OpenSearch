...
public final class LongKeyedBucketOrdsBenchmark_singleBucketIntoSingleImmutableBimorphicInvocation_jmhTest {
    ...
    public BenchmarkTaskResult singleBucketIntoSingleImmutableBimorphicInvocation_Throughput(
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            singleBucketIntoSingleImmutableBimorphicInvocation_thrpt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void singleBucketIntoSingleImmutableBimorphicInvocation_thrpt_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult singleBucketIntoSingleImmutableBimorphicInvocation_AverageTime(
        InfraControl control,
        ThreadParams threadParams
    ) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            singleBucketIntoSingleImmutableBimorphicInvocation_avgt_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public static void singleBucketIntoSingleImmutableBimorphicInvocation_avgt_jmhStub(
        InfraControl control,
        RawResults result,
        BenchmarkParams benchmarkParams,
        IterationParams iterationParams,
    ...
    public BenchmarkTaskResult singleBucketIntoSingleImmutableBimorphicInvocation_SampleTime(
        InfraControl control,
        ThreadParams threadParams
    ) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            singleBucketIntoSingleImmutableBimorphicInvocation_sample_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
    ...
    public BenchmarkTaskResult singleBucketIntoSingleImmutableBimorphicInvocation_SingleShotTime(
        InfraControl control,
        ThreadParams threadParams
    ) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            singleBucketIntoSingleImmutableBimorphicInvocation_ss_jmhStub(
                control,
                res,
                benchmarkParams,
                iterationParams,
