...
public class SearchPipelineCommonIT extends OpenSearchIntegTestCase {
    ...
    public void testFilterQuery() {
        ...
        assertEquals(2, Objects.requireNonNull(rsp.getHits().getTotalHits()).value);
        ...
        assertEquals(1, Objects.requireNonNull(rsp.getHits().getTotalHits()).value);
    ...
    public void testUpdateSearchPipeline() throws Exception {
        ...
        assertEquals(1, Objects.requireNonNull(initialRsp.getHits().getTotalHits()).value);
    ...
    private void deletePipeline() {
        AcknowledgedResponse ackRsp;
        ackRsp = client().admin().cluster().deleteSearchPipeline(new DeleteSearchPipelineRequest(PIPELINE_NAME)).actionGet();
        assertTrue(ackRsp.isAcknowledged());
    }
}
