...
public final class AllowlistClass {
    ...
    public AllowlistClass(String origin, String javaClassName,
                          List<AllowlistConstructor> allowlistConstructors, List<AllowlistMethod> allowlistMethods, List<AllowlistField> allowlistFields,
