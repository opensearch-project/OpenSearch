...
/**
 * Method represents the equivalent of a Java method available as a allowlisted class method
...
public class AllowlistMethod {
     ...
     */
    public AllowlistMethod(String origin, String augmentedCanonicalClassName, String methodName,
