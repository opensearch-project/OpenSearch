...
public class OverloadTests extends ScriptTestCase {
    ...
    public void testConstructor() {
        assertEquals(true, exec("org.opensearch.painless.FeatureTestObject f = new org.opensearch.painless.FeatureTestObject();" +
                                "return f.x == 0 && f.y == 0;"));
        assertEquals(true, exec("org.opensearch.painless.FeatureTestObject f = new org.opensearch.painless.FeatureTestObject(1, 2);" +
                                "return f.x == 1 && f.y == 2;"));
    }
