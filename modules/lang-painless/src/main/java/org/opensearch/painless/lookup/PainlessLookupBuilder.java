...
import org.opensearch.painless.spi.*;
            ...
            for (Allowlist allowlist : allowlists) {
                for (AllowlistClass allowlistClass : allowlist.allowlistClasses) {
                    ...
                    painlessLookupBuilder.addPainlessClass(
                            allowlist.classLoader, allowlistClass.javaClassName,
            ...
            for (Allowlist allowlist : allowlists) {
                for (AllowlistClass allowlistClass : allowlist.allowlistClasses) {
                    ...
                    for (AllowlistConstructor allowlistConstructor : allowlistClass.allowlistConstructors) {
                        ...
                        painlessLookupBuilder.addPainlessConstructor(
                                targetCanonicalClassName, allowlistConstructor.canonicalTypeNameParameters,
                    ...
                    for (AllowlistMethod allowlistMethod : allowlistClass.allowlistMethods) {
                        ...
                        painlessLookupBuilder.addPainlessMethod(
                                allowlist.classLoader, targetCanonicalClassName, allowlistMethod.augmentedCanonicalClassName,
                                allowlistMethod.methodName, allowlistMethod.returnCanonicalTypeName,
                                allowlistMethod.canonicalTypeNameParameters, allowlistMethod.painlessAnnotations);
                    }
                    ...
                    for (AllowlistField allowlistField : allowlistClass.allowlistFields) {
                        ...
                        painlessLookupBuilder.addPainlessField(
                                targetCanonicalClassName, allowlistField.fieldName, allowlistField.canonicalTypeNameParameter);
                    }
                }
                ...
                for (AllowlistMethod allowlistStatic : allowlist.allowlistImportedMethods) {
                    ...
                    painlessLookupBuilder.addImportedPainlessMethod(
                            allowlist.classLoader, allowlistStatic.augmentedCanonicalClassName,
                            allowlistStatic.methodName, allowlistStatic.returnCanonicalTypeName,
                ...
                for (AllowlistClassBinding allowlistClassBinding : allowlist.allowlistClassBindings) {
                    ...
                    painlessLookupBuilder.addPainlessClassBinding(
                            allowlist.classLoader, allowlistClassBinding.targetJavaClassName, allowlistClassBinding.methodName,
                            allowlistClassBinding.returnCanonicalTypeName, allowlistClassBinding.canonicalTypeNameParameters,
                ...
                for (AllowlistInstanceBinding allowlistInstanceBinding : allowlist.allowlistInstanceBindings) {
                    ...
                    painlessLookupBuilder.addPainlessInstanceBinding(
                            allowlistInstanceBinding.targetInstance, allowlistInstanceBinding.methodName,
                            allowlistInstanceBinding.returnCanonicalTypeName, allowlistInstanceBinding.canonicalTypeNameParameters);
                }
            }
    ...
    private void generateBridgeMethod(PainlessClassBuilder painlessClassBuilder, PainlessMethod painlessMethod) {
        ...
        if (bridgePainlessMethod == null) {
            ...
            String bridgeClassName =
                    "org/opensearch/painless/Bridge$" + javaMethod.getDeclaringClass().getSimpleName() + "$" + javaMethod.getName();
