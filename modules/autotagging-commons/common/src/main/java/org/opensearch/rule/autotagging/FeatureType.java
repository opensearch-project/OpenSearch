...
public interface FeatureType extends Writeable {
     ...
     */
    Map<Attribute, Integer> getPrioritizedTopLevelAttributes();
    ...
    default Map<String, Attribute> getAllowedAttributesRegistry() {
        return getPrioritizedTopLevelAttributes().keySet()
            .stream()
            .collect(Collectors.toUnmodifiableMap(Attribute::getName, attribute -> attribute));
    }
