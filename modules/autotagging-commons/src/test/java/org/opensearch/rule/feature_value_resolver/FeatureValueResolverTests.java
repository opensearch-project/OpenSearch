...
public class FeatureValueResolverTests extends OpenSearchTestCase {
    ...
    public void testResolveSingleExtractorSingleSubfieldSingleValue() {
        ...
        when(store.getAll("username|alice")).thenReturn(List.of(Set.of("label1")));
    ...
    public void testResolveSingleExtractorWithNoSubfieldsDefaultsToEmptyString() {
        ...
        when(store.getAll("|value")).thenReturn(List.of(Set.of("labelX")));
    ...
    public void testResolveMultipleExtractorsIntersection() {
        ...
        when(store1.getAll("username|alice")).thenReturn(List.of(Set.of("label1", "common")));
        when(store2.getAll("role|admin")).thenReturn(List.of(Set.of("common", "label2")));
    ...
    public void testResolveWithNoIntersectionReturnsEmpty() {
        ...
        when(store1.getAll("username|alice")).thenReturn(List.of(Set.of("label1")));
        when(store2.getAll("role|admin")).thenReturn(List.of(Set.of("label2")));
