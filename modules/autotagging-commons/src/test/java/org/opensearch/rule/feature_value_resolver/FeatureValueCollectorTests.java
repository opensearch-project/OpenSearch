...
public class FeatureValueCollectorTests extends OpenSearchTestCase {
    ...
    public void testSingleMatchingValueReturnsCandidateValues() {
        ...
        when(attributeValueStore.getAll("username|alice")).thenReturn(List.of(Set.of("label1", "label2")));
    ...
    public void testMultipleMatchingValuesMerged() {
        ...
        when(attributeValueStore.getAll("username|alice")).thenReturn(List.of(Set.of("label1")));
        when(attributeValueStore.getAll("username|bob")).thenReturn(List.of(Set.of("label2")));
