...
$OPENSEARCH_HOME/bin/opensearch-certutil ca --out ca.p12 --pass "ca-password" --days 9999
...
$OPENSEARCH_HOME/bin/opensearch-certutil cert --out http.zip --pass "http-password" \
...
$OPENSEARCH_HOME/bin/opensearch-certutil cert --out client.zip --pass "client-password" \
