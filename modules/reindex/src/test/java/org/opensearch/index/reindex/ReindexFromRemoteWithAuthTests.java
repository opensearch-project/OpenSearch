...
public class ReindexFromRemoteWithAuthTests extends OpenSearchSingleNodeTestCase {
    ...
    protected Collection<Class<? extends Plugin>> getPlugins() {
        return Arrays.asList(Netty4Module.class, ReindexFromRemoteWithAuthTests.TestPlugin.class, ReindexModule.class);
    }
    ...
    protected Settings nodeSettings() {
        ...
        settings.put(NetworkModule.HTTP_TYPE_KEY, Netty4Module.NETTY_HTTP_TRANSPORT_NAME);
