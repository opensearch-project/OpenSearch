...
public class BucketOrderProtoUtilsTests extends OpenSearchTestCase {
    ...
    public void testParseOrderParamWithSingleCountDescOrder() {
        ...
        assertEquals("Order should be COUNT_DESC", BucketOrder.count(false), builder.order());
    }
    ...
    public void testParseOrderParamWithSingleCountAscOrder() {
        ...
        assertEquals("Order should be COUNT_ASC", BucketOrder.count(true), builder.order());
    }
    ...
    public void testParseOrderParamWithSubAggregationAscOrder() {
        ...
        assertEquals("Order should be aggregation order ASC", BucketOrder.aggregation("my_agg", true), builder.order());
    }
    ...
    public void testParseOrderParamWithSubAggregationDescOrder() {
        ...
        assertEquals("Order should be aggregation order DESC", BucketOrder.aggregation("my_agg", false), builder.order());
    }
    ...
    public void testParseOrderParamWithSubAggregationPathOrder() {
        ...
        assertEquals(
            "Order should be aggregation path order DESC",
            BucketOrder.aggregation("my_agg>nested_metric", false),
            builder.order()
        );
    }
    ...
    public void testParseOrderParamWithNullSortOrderMapInList() {
        ...
        assertTrue(
            "Exception message should mention 'SortOrderMap must not be null'",
            exception.getMessage().contains("SortOrderMap must not be null")
        );
    }
    ...
    public void testParseOrderParamPreservesBuilderState() {
        ...
        assertEquals("Order should be set", BucketOrder.count(false), builder.order());
    }
    ...
    public void testParseOrderParamOverridesPreviousOrder() {
        ...
        assertEquals("Order should be overridden to COUNT_DESC", BucketOrder.count(false), builder.order());
    }
}
