...
public class Netty4GrpcServerTransportTests extends OpenSearchTestCase {
    ...
    public void testBasicStartAndStop() {
        try (Netty4GrpcServerTransport transport = new Netty4GrpcServerTransport(createSettings(), services, networkService, null)) {
            transport.start();
    ...
    public void testWithCustomPort() {
        ...
        try (Netty4GrpcServerTransport transport = new Netty4GrpcServerTransport(settings, services, networkService, null)) {
            transport.start();
