...
public class SearchHitNestedIdentityProtoUtilsTests extends OpenSearchTestCase {
    ...
    public void testToProtoWithBasicNestedIdentity() throws Exception {
        ...
        assertFalse("Nested field should not be set", protoNestedIdentity.hasUnderscoreNested());
    }
    ...
    public void testToProtoWithNestedNestedIdentity() throws Exception {
        ...
        assertEquals("Field should match", "parent_field", protoNestedIdentity.getField());
        assertEquals("Offset should match", 5, protoNestedIdentity.getOffset());
        assertTrue("Nested field should be set", protoNestedIdentity.hasUnderscoreNested());

        // Verify the nested identity
        NestedIdentity nestedProtoNestedIdentity = protoNestedIdentity.getUnderscoreNested();
        ...
        assertFalse("Nested nested field should not be set", nestedProtoNestedIdentity.hasUnderscoreNested());
    }
    ...
    public void testToProtoWithDeeplyNestedNestedIdentity() throws Exception {
        ...
        NestedIdentity childProtoNestedIdentity = protoNestedIdentity.getUnderscoreNested();
        ...
        assertTrue("Child nested field should be set", childProtoNestedIdentity.hasUnderscoreNested());

        // Verify the grandchild nested identity
        NestedIdentity grandchildProtoNestedIdentity = childProtoNestedIdentity.getUnderscoreNested();
        ...
        assertFalse("Grandchild nested field should not be set", grandchildProtoNestedIdentity.hasUnderscoreNested());
    }
