 ...
 * <p>
 * This is the gRPC transport equivalent of the REST API's XContent parsing.
 * The REST side uses {@link SearchSourceBuilder#parseXContent(XContentParser, boolean)}
 * to parse JSON search request bodies, while this class parses from protobuf format.
 * <p>
 * Key conversions:
 * <ul>
 *   <li>Queries: QueryContainer proto → {@link org.opensearch.index.query.QueryBuilder}</li>
