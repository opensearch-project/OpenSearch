...
public class SystemdModuleTests extends OpenSearchTestCase {
    ...
    public void testIsImplicitlyNotEnabled() {
        final SystemdModule plugin = new SystemdModule(null);
    ...
    public void testIsExplicitlyNotEnabled() {
        final SystemdModule plugin = new SystemdModule(Boolean.FALSE.toString());
        plugin.createComponents(null, null, threadPool, null, null, null, null, null, null, null, null);
        assertFalse(plugin.isEnabled());
        assertNull(plugin.extender());
    }
    ...
    public void testInvalid() {
        ...
        final RuntimeException e = expectThrows(RuntimeException.class, () -> new SystemdModule(esSDNotify));
    ...
    private void runTestOnNodeStarted(
        ...
        final int rc,
        final BiConsumer<Optional<Exception>, SystemdModule> assertions
    ) {
        runTest(esSDNotify, rc, assertions, SystemdModule::onNodeStarted, "READY=1");
    }
    ...
    private void runTestClose(final String esSDNotify, final int rc, final BiConsumer<Optional<Exception>, SystemdModule> assertions) {
        runTest(esSDNotify, rc, assertions, SystemdModule::close, "STOPPING=1");
    }
    ...
    private void runTest(
        ...
        final int rc,
        final BiConsumer<Optional<Exception>, SystemdModule> assertions,
        final CheckedConsumer<SystemdModule, IOException> invocation,
        ...
        final SystemdModule plugin = new SystemdModule(esSDNotify) {
