...
public class TemporalRoutingProcessorTests extends OpenSearchTestCase {
    ...
    public void testFactoryValidation() throws Exception {
        ...
        exception = expectThrows(
            OpenSearchParseException.class,
            () -> factory.create(Collections.emptyMap(), "test", null, config2)
        );
        ...
        exception = expectThrows(
            OpenSearchParseException.class,
            () -> factory.create(Collections.emptyMap(), "test", null, config3)
        );
        ...
        exception = expectThrows(
            OpenSearchParseException.class,
            () -> factory.create(Collections.emptyMap(), "test", null, config4)
        );
