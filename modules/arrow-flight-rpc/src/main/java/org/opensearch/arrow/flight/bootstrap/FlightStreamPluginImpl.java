...
public class FlightStreamPluginImpl extends BaseFlightStreamPlugin {
    ...
    public Collection<Object> createComponents(
        ...
        flightService.initialize(clusterService, threadPool, client);
    ...
    public Map<String, Supplier<AuxTransport>> getAuxTransports(
        ...
        FlightServerTransport flightServerTransport = new FlightServerTransport(settings, networkService, flightService::startFlightServer);
        flightService.setFlightTransport(flightServerTransport);
        return Collections.singletonMap(FlightServerTransport.AUX_TRANSPORT_TYPES_KEY, () -> flightServerTransport);
    }
    ...
    public List<Setting<?>> getSettings() {
        return new ArrayList<>(
            Arrays.asList(
                FlightServerTransport.SETTING_FLIGHT_PORTS,
                FlightServerTransport.SETTING_FLIGHT_HOST,
                FlightServerTransport.SETTING_FLIGHT_BIND_HOST,
                FlightServerTransport.SETTING_FLIGHT_PUBLISH_HOST
            )
        ) {
            {
