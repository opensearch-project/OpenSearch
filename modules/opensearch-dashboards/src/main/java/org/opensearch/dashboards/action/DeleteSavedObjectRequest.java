...
/**
 * Request to delete a saved object by index and document id.
 */
public class DeleteSavedObjectRequest extends ActionRequest implements IndicesRequest.Replaceable {

    private String index;
    private String documentId;

    public DeleteSavedObjectRequest() {}

    public DeleteSavedObjectRequest(String index, String documentId) {
        this.index = index;
        this.documentId = documentId;
    }

    public DeleteSavedObjectRequest(StreamInput in) throws IOException {
        super(in);
