...
+
--
include::{opensearch-repo-dir}/upgrade/disable-shard-alloc.asciidoc[]
--
...
include::{opensearch-repo-dir}/upgrade/synced-flush.asciidoc[]
--
// end::stop_indexing[]
...
+
--
include::{opensearch-repo-dir}/upgrade/shut-down-node.asciidoc[]
--
...
include::{opensearch-repo-dir}/setup/restart-cluster.asciidoc[tag=disable_shard_alloc]

include::{opensearch-repo-dir}/setup/restart-cluster.asciidoc[tag=stop_indexing]
+
--
