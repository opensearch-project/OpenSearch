...
Ideally, OpenSearch should run alone on a server and use all of the
...
By default, OpenSearch assumes that you are working in development mode.
...
As soon as you configure a network setting like `network.host`, OpenSearch
