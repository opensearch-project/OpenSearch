...
file. Elasticsearch exposes three properties, `${sys:opensearch.logs.base_path}`,
...
--------------------------------------------------
:es-json-layout-java-doc: {elasticsearch-javadoc}/org/opensearch/common/logging/OpenSearchJsonLayout.html
