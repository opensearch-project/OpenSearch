...
--------------------------------------------------
echo "deb https://artifacts.opensearch.org/packages/{major-version}/apt stable main" | sudo tee /etc/apt/sources.list.d/elastic-{major-version}.list
--------------------------------------------------
...
["source","sh",subs="attributes,callouts"]
--------------------------------------------------
echo "deb https://artifacts.opensearch.org/packages/{major-version}-prerelease/apt stable main" | sudo tee /etc/apt/sources.list.d/elastic-{major-version}.list
--------------------------------------------------
...
["source","sh",subs="attributes,callouts"]
--------------------------------------------------
echo "deb https://artifacts.opensearch.org/packages/oss-{major-version}-prerelease/apt stable main" | sudo tee /etc/apt/sources.list.d/elastic-{major-version}.list
--------------------------------------------------
...
["source","sh",subs="attributes,callouts"]
--------------------------------------------------
echo "deb https://artifacts.opensearch.org/packages/oss-{major-version}/apt stable main" | sudo tee /etc/apt/sources.list.d/elastic-{major-version}.list
--------------------------------------------------
...
--------------------------------------------
wget https://artifacts.opensearch.org/downloads/elasticsearch/elasticsearch-{version}-amd64.deb
wget https://artifacts.opensearch.org/downloads/elasticsearch/elasticsearch-{version}-amd64.deb.sha512
...
https://artifacts.opensearch.org/downloads/elasticsearch/elasticsearch-oss-{version}-amd64.deb
