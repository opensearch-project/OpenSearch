==== Checking that {opensearch} is running

You can test that your {opensearch} node is running by sending an HTTP
...
// TESTRESPONSE[s/"cluster_name" : "opensearch",/"cluster_name" : "$body.cluster_name",/]
