...
Download the `.zip` archive for OpenSearch v{version} from: https://artifacts.opensearch.org/downloads/opensearch/opensearch-{version}-windows-x86_64.zip
...
https://artifacts.opensearch.org/downloads/opensearch/opensearch-oss-{version}-windows-x86_64.zip
...
`SERVICE_DESCRIPTION`::
  ...
  The description of the service.  Defaults to `Elasticsearch <version> Windows Service - https://opensearch.org`.
