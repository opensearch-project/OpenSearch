...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=index-alias-filter]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=index-routing]
