...
<<indices-aliases, index alias>>. When targeting an alias, the alias
is updated to point to the new index.
...
include::{opensearch-repo-dir}/indices/create-index.asciidoc[tag=index-name-reqs]
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=aliases]
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=mappings]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=settings]
