...
`<segment>`::
(String)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=segment]

`generation`::
(Integer)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=generation]

`num_docs`::
(Integer)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=docs-count]

`deleted_docs`::
(Integer)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=docs-deleted]

`size_in_bytes`::
(Integer)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=segment-size]

`memory_in_bytes`::
(Integer)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=memory]

`committed`::
(Boolean)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=committed]

`search`::
(Boolean)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=segment-search]

`version`::
(String)
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=segment-version]
...
===== Get segment information for all indices in a cluster
