...
include::{opensearch-ref-dir}/rest-api/common-parms.asciidoc[tag=master-timeout]
...
[%collapsible%open]
====
include::{opensearch-ref-dir}/rest-api/common-parms.asciidoc[tag=aliases]
+
Response includes an empty object if no aliases would be applied. 

include::{opensearch-ref-dir}/rest-api/common-parms.asciidoc[tag=mappings]
+
Omitted from the response if no mappings would be applied.

include::{opensearch-ref-dir}/rest-api/common-parms.asciidoc[tag=settings]
+
