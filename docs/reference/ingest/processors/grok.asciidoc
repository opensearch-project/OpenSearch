...
If you need help building patterns to match your logs, you will find the https://grokconstructor.appspot.com[Grok Constructor] is a useful tool.
...
It is recommended to enable debug logging for Grok so that any additional messages may also be seen in the Elasticsearch
server log.
