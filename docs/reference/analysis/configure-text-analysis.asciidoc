...
By default, {opensearch} uses the <<analysis-standard-analyzer,`standard` analyzer>> for
...
If the standard analyzer does not fit your needs, review and test {opensearch}'s other
