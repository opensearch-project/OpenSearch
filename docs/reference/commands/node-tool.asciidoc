...
[source,txt]
----
node$ ./bin/opensearch-node remove-settings xpack.monitoring.exporters.my_exporter.host
...
[source,txt]
----
node$ ./bin/opensearch-node remove-settings xpack.monitoring.*
----
...
[source,txt]
----
node$ ./bin/opensearch-node remove-customs snapshot_lifecycle
