...
// TODO: Replace the setting 'xpack.monitoring' in the example, as it's not supported
[source,txt]
----
...
// TODO: Replace the metadata 'snapshot_lifecycle' in the example, as it's not supported
[source,txt]
----
