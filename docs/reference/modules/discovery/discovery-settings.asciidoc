...
the cluster later. If `discovery.type` is set to `single-node`, {opensearch} forms a
...
takes longer than this threshold then {opensearch} logs a warning. Defaults to `5s`.
