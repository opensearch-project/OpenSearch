...
OpenSearch binds to localhost only by default.  This is sufficient for you
...
Each {opensearch} node uses the network for two different methods of communication:
