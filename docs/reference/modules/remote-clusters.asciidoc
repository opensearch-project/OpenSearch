...
You can connect a local cluster to other {opensearch} clusters, known as _remote
...
nodes in the remote cluster. {opensearch} requires these connections to remain open,
