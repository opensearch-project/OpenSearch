...
{opensearch} rejects any request that creates more shards than this limit allows. For
...
shards, {opensearch} rejects any request that adds five or more shards to the cluster.
...
include::{opensearch-repo-dir}/indices/dangling-indices-list.asciidoc[tag=dangling-index-description]
