...
You know more about your data than OpenSearch can guess, so while dynamic
...
include::{opensearch-repo-dir}/indices/put-mapping.asciidoc[tag=change-field-mapping]

include::{opensearch-repo-dir}/indices/put-mapping.asciidoc[tag=rename-field]
