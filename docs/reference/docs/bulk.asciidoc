...
`index`, or `write` index privilege.
...
.NET::
    See https://www.opensearch.org/guide/en/opensearch/client/net-api/current/indexing-documents.html#bulkall-observable[`BulkAllObservable`]
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=refresh]
...
+
--
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=bulk-index]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=bulk-id]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=bulk-require-alias]
--
...
`_type`::
(string)
The document type associated with the operation. {opensearch} indices now support a
...
`index`::
(string)
Name of the index associated with the failed operation.
======
=====
====
