...
When you submit an update by query request, {opensearch} gets a snapshot of the index
...
While processing an update by query request, {opensearch} performs multiple search
...
If the request contains `wait_for_completion=false`, {opensearch}
performs some preflight checks, launches the request, and returns a
<<tasks,`task`>> you can use to cancel or get the status of the task.
{opensearch} creates a record of this task as a document at `.tasks/task/${taskId}`.
When you are done with a task, you should delete the task document so
{opensearch} can reclaim the space.
...
+
To search all indices in a cluster, omit this parameter or use
`_all` or `*`.
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=analyzer]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=analyze_wildcard]

`conflicts`::
  (Optional, string) What to do if update by query hits version conflicts:
  `abort` or `proceed`. Defaults to `abort`.

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=default_operator]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=df]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=expand-wildcards]
+
Defaults to `open`.

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=from]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=index-ignore-unavailable]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=lenient]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=max_docs]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=pipeline]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=preference]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=search-q]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=request_cache]

`refresh`::
(Optional, Boolean)
If `true`, {opensearch} refreshes affected shards to make the operation visible to
search. Defaults to `false`.

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=requests_per_second]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=routing]
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=scroll_size]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=search_type]
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=slices]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=sort]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=source]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=source_excludes]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=source_includes]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=stats]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=terminate_after]
...
Defaults to `1m` (one minute). This guarantees {opensearch} waits for at least the
timeout before failing. The actual wait time could be longer, particularly when
multiple waits occur.
--

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=version]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=wait_for_active_shards]
...
Setting `slices` to `auto` will let OpenSearch choose the number of slices
