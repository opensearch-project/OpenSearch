...
`<target>`::
(Required, string) Name of the index to target.
+
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=if_seq_no]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=if_primary_term]
...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=doc-version]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=version_type]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=wait_for_active_shards]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=require-alias]
...
`_type`::
The document type. {opensearch} indices now support a single document type, `_doc`.
...
OpenSearch runs on the shard receiving the updates.
...
In addition to the `external` version type, OpenSearch
