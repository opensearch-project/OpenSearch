...
To help people stay on top of those, we maintain a dedicated https://www.opensearch.org/guide/en/elasticsearch/resiliency/current/index.html[resiliency page]
