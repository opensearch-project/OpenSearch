...
more repositories. A snapshot is a backup of an index or running {opensearch} cluster.
...
If the repository fails during the request, {opensearch} returns an error.
--
