...
how to write a plugin so that OpenSearch will properly load it. To register
...
--------------------------------------------------
include-tagged::{plugins-examples-dir}/script-expert-scoring/src/main/java/org/opensearch/example/expertscript/ExpertScriptPlugin.java[expert_engine]
--------------------------------------------------
