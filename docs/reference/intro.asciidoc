...
construct SQL-style queries to search and aggregate data inside {es} through plugins 
contributed by the community, and JDBC and ODBC drivers enable a broad range of
