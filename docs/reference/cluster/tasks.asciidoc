...
include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=task-id]


[[tasks-api-query-params]]
==== {api-query-parms-title}

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=actions]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=detailed]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=group-by]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=node-id-query-parm]

include::{opensearch-repo-dir}/rest-api/common-parms.asciidoc[tag=parent-task-id]
