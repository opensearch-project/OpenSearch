...
It is important to note that after processing any reroute commands {opensearch} will
...
shard allocation is usually fully automatically handled by {opensearch}. Reasons why a
