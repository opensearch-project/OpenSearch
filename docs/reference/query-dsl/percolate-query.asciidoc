...
json object that represents an actual OpenSearch query. The `query` field
...
`document_type`:: The type / mapping of the document being percolated.
...
`type`:: The type of the document to fetch.
