...
Lets say you're going to upgrade to a new major version and in order for the new OpenSearch version to still be able
to read your queries you need to reindex your queries into a new index on the current OpenSearch version:
