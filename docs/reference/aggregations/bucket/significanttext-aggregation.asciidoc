...
// TODO(OpenSearch): Replace the example for OpenSearch. To read the news in the example: https://www.prweb.com/releases/2015/09/prweb12964572.htm
...
--------------------------------------------------
// NOTCONSOLE
Mike Pozmantier was one of many judges on a panel and <keyword> was used in one of many projects being judged.
...
Mr Pozmantier and other one-off associations with <keyword> no longer appear in the aggregation 
