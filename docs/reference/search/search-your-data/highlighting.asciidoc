...
OpenSearch highlights the fields in the order that they are sent, but per the
...
None of the highlighters built into OpenSearch care about the order that the
