...
WARNING: {opensearch} uses Lucene's internal doc IDs as tie-breakers. These internal
...
that {opensearch} needs to return the correct documents. The search context is created
