...
{"index":{"_id":1}}
{"user" : { "id": "kimchy" }, "@timestamp" : "2099-11-15T14:12:12", "message" : "trying out OpenSearch"}
{"index":{"_id":2}}
...
because {opensearch} knows the `post_date` field should be a date due to dynamic
