...
PUT /index_1/_doc/1
{
  "title": "OpenSearch, Vol.1", "category": "Non-Fiction",
  "author": {
    "first_name": "OpenSearch",
    "last_name": "Project"
  }
}
...
PUT /index_1/_doc/2
{
  "title": "OpenSearch, Vol.2", "category": "Non-Fiction",
  "author": {
    "first_name": "OpenSearch",
    "last_name": "Project"
  }
...
PUT /index_1/_doc/3
{
  "title": "OpenSearch, Vol.3", "category": "Non-Fiction",
  "author": {
    "first_name": "OpenSearch",
    "last_name": "Project"
  }
...
PUT /index_1/_doc/4
{
  "title": "OpenSearch, Vol.4", "category": "Non-Fiction",
  "author": {
    "first_name": "OpenSearch",
    "last_name": "Project"
  }
