...
:doc-tests: {opensearch-root}/client/rest/src/test/java/org/opensearch/client/documentation
include::usage.asciidoc[]
include::configuration.asciidoc[]

:doc-tests: {opensearch-root}/client/sniffer/src/test/java/org/opensearch/client/sniff/documentation
