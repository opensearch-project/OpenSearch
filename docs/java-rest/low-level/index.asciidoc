...
:doc-tests: {search-root}/client/rest/src/test/java/org/opensearch/client/documentation
include::usage.asciidoc[]
include::configuration.asciidoc[]

:doc-tests: {search-root}/client/sniffer/src/test/java/org/opensearch/client/sniff/documentation
