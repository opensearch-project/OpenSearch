...
The Java High Level REST Client depends on the OpenSearch core project which provides
...
aggregation (or pipeline aggregation) supported by OpenSearch. All builders extend the
