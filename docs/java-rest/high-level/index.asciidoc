...
The Java High Level REST Client depends on the OpenSearch core project.
It accepts the same request arguments as the `TransportClient` and returns
the same response objects.

--

:doc-tests: {OpenSearch-root}/client/rest-high-level/src/test/java/org/opensearch/client/documentation
