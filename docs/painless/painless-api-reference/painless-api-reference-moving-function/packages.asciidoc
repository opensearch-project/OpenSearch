...
[role="exclude",id="painless-api-reference-moving-function-org-opensearch-search-aggregations-pipeline"]
=== Moving Function API for package org.opensearch.search.aggregations.pipeline
See the <<painless-api-reference-moving-function, Moving Function API>> for a high-level overview of all packages and classes.
