...
include::{search-root}/docs/Versions.asciidoc[]
...
--------------------------------------------------
<repository>
    <id>opensearch-lucene-snapshots</id>
    <name>OpenSearch Lucene Snapshots</name>
...
:client-reindex-tests: {search-root}/modules/reindex/src/internalClusterTest/java/org/opensearch/client/documentation
