...
:client-tests: {search-root}/server/src/internalClusterTest/java/org/elasticsearch/client/documentation
:hlrc-tests: {search-root}/client/rest-high-level/src/test/java/org/elasticsearch/client
