...
OpenSearch provides a full Java query dsl in a similar manner to the
...
:query-dsl-test: {OpenSearch-root}/client/rest-high-level/src/test/java/org/opensearch/client/documentation/QueryDSLDocumentationTests.java
