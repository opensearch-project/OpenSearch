...
module into opensearch. It uses the https://bitbucket.org/eunjeon/mecab-ko-dic[mecab-ko-dic dictionary]
...
dictionary to `$OPENSEARCH_HOME/config/userdict_ko.txt`:
