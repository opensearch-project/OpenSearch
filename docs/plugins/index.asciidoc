...
Plugins are a way to enhance the core OpenSearch functionality in a custom
...
Core Plugins::    This category identifies plugins that are part of OpenSearch
project. Delivered at the same time as OpenSearch, their version number always
matches the version number of OpenSearch itself. These plugins are maintained
by the OpenSearch team with the appreciated help of amazing community members (for
...
the OpenSearch project. They are provided by individual developers or private
