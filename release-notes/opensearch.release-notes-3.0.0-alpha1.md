...
- Upgrade to Lucene 10 - PR ([#16366](https://github.com/opensearch-project/OpenSearch/pull/16366))
...
- List of deprecated code removal in 3.0- partially done ([#2273](https://github.com/opensearch-project/OpenSearch/issues/2773))
