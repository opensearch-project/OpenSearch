...
* Prevent criteria updates for context-aware indices to simplify version management ([#20250](https://github.com/opensearch-project/OpenSearch/pull/20250))

### Bug Fixes

* Fix range validations in query builder and field mapper ([#20518](https://github.com/opensearch-project/OpenSearch/pull/20518))
...
* Relax `updatedAt` validation for workload group creation to handle minor clock skew ([#20486](https://github.com/opensearch-project/OpenSearch/pull/20486))
...
* Fix false-positive index pattern collision detection for multi-wildcard patterns ([#20702](https://github.com/opensearch-project/OpenSearch/pull/20702))
...
* Lazily initialize stored field reader in `SourceLookup` to avoid unnecessary `madvise` calls for scripts that don't read `_source` ([#20827](https://github.com/opensearch-project/OpenSearch/pull/20827))
...
* Batch deletions of stale cluster metadata manifests in remote store cleanup to prevent timeouts and metadata pile-up ([#20566](https://github.com/opensearch-project/OpenSearch/pull/20566))
...
* Harden detection of HTTP/3 support by verifying Quic native library availability for the target platform ([#20680](https://github.com/opensearch-project/OpenSearch/pull/20680))
