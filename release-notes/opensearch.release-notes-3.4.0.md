...
* Refactored stats classed exposed as public APIs to use the Builder pattern instead of constructors ([#19225](https://github.com/opensearch-project/OpenSearch/issues/19225))
