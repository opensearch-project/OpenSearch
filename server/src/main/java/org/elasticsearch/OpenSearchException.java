...
public class OpenSearchException extends RuntimeException implements ToXContentFragment, Writeable {
    ...
    private enum OpenSearchExceptionHandle {
        ...
        PRIMARY_MISSING_ACTION_EXCEPTION(PrimaryMissingActionException.class,
                PrimaryMissingActionException::new, 70, UNKNOWN_VERSION_ADDED),
        ...
        TIMESTAMP_PARSING_EXCEPTION(TimestampParsingException.class,
                TimestampParsingException::new, 78, UNKNOWN_VERSION_ADDED),
        ROUTING_MISSING_EXCEPTION(RoutingMissingException.class,
                RoutingMissingException::new, 79, UNKNOWN_VERSION_ADDED),
        ...
        NO_SHARD_AVAILABLE_ACTION_EXCEPTION(NoShardAvailableActionException.class,
                NoShardAvailableActionException::new, 130, UNKNOWN_VERSION_ADDED),
        UNAVAILABLE_SHARDS_EXCEPTION(UnavailableShardsException.class,
                UnavailableShardsException::new, 131, UNKNOWN_VERSION_ADDED),
