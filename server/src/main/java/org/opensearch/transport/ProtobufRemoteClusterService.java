...
* @opensearch.internal
*/
public final class ProtobufRemoteClusterService extends RemoteClusterAware implements Closeable {

    private final Logger logger = LogManager.getLogger(ProtobufRemoteClusterService.class);
    ...
    */
    ...
    ProtobufRemoteClusterConnection getRemoteClusterConnection(String cluster) {
        if (enabled == false) {
    ...
    private synchronized void updateSkipUnavailable(String clusterAlias, Boolean skipUnavailable) {
        ProtobufRemoteClusterConnection remote = this.remoteClusters.get(clusterAlias);
        if (remote != null) {
    ...
    */
    synchronized void updateRemoteCluster(String clusterAlias, Settings newSettings, ActionListener<Void> listener) {
        ...
        if (remote == null) {
            ...
            remote = new ProtobufRemoteClusterConnection(finalSettings, clusterAlias, transportService);
    ...
    */
    ...
    public Stream<ProtobufRemoteConnectionInfo> getRemoteConnectionInfos() {
        return remoteClusters.values().stream().map(ProtobufRemoteClusterConnection::getConnectionInfo);
    }
    ...
    */
    public void collectNodes(Set<String> clusters, ActionListener<BiFunction<String, String, DiscoveryNode>> listener) {
        ...
        Map<String, ProtobufRemoteClusterConnection> remoteClusters = this.remoteClusters;
    ...
    */
    ...
    Collection<ProtobufRemoteClusterConnection> getConnections() {
