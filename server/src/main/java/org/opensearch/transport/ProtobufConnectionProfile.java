...
* @opensearch.internal
*/
public final class ProtobufConnectionProfile {

    /**
     * takes a {@link ProtobufConnectionProfile} resolves it to a fully specified (i.e., no nulls) profile
    */
    public static ProtobufConnectionProfile resolveConnectionProfile(
        @Nullable ProtobufConnectionProfile profile,
        ProtobufConnectionProfile fallbackProfile
    ) {
        ...
        if (profile == null) {
            ...
            && profile.getCompressionEnabled() != null) {
                ...
                ProtobufConnectionProfile.Builder builder = new ProtobufConnectionProfile.Builder(profile);
    ...
    */
    public static ProtobufConnectionProfile buildDefaultConnectionProfile(Settings settings) {
    ...
    */
    public static ProtobufConnectionProfile buildSingleChannelProfile(TransportRequestOptions.Type channelType) {
    ...
    */
    public static ProtobufConnectionProfile buildSingleChannelProfile(
    ...
    private ProtobufConnectionProfile(
    ...
    /**
     * A builder to build a new {@link ProtobufConnectionProfile}
    *
    * @opensearch.internal
    */
    public static class Builder {
        ...
        public Builder(ProtobufConnectionProfile source) {
        ...
        */
        public ProtobufConnectionProfile build() {
            ...
            return new ProtobufConnectionProfile(
