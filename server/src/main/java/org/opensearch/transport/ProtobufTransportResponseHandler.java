...
// * @opensearch.internal
// */
// public interface ProtobufTransportResponseHandler<T extends TransportResponse> extends ProtobufWriteable.Reader<T> {
...
//     default <Q extends TransportResponse> ProtobufTransportResponseHandler<Q> wrap(
