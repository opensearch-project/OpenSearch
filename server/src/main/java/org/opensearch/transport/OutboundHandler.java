...
final class OutboundHandler {
    ...
    void internalSend(TcpChannel channel, SendContext sendContext) throws IOException {
    ...
    static class SendContext extends NotifyOnceListener<Void> implements CheckedSupplier<BytesReference, IOException> {
