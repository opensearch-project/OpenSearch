...
//                                    listener.onFailure(e);
        ...
        clusterService.submitStateUpdateTask(
                ...
                new ClusterStateUpdateTask(Priority.URGENT) {
                    ...
                    public ClusterState execute(ClusterState currentState) {
                        ...
                        decommissionAttributeMetadata = new DecommissionAttributeMetadata(recommissionAttribute, DecommissionStatus.RECOMMISSIONING);
                        mdBuilder.putCustom(DecommissionAttributeMetadata.TYPE, decommissionAttributeMetadata);
                        return ClusterState.builder(currentState).metadata(mdBuilder).build();
                    }
    ...
    public boolean isValidRecommission(DecommissionAttributeMetadata decommissionAttributeMetadata, DecommissionAttribute recommissionAttribute) {
        if (decommissionAttributeMetadata != null
                && (decommissionAttributeMetadata.status().equals(DecommissionStatus.DECOMMISSIONED)
                    || decommissionAttributeMetadata.status().equals(DecommissionStatus.DECOMMISSIONING))
