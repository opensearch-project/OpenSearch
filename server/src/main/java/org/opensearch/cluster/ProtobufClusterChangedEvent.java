...
* @opensearch.internal
*/
public class ProtobufClusterChangedEvent {

    private final String source;

    private final ProtobufClusterState previousState;
    ...
    */
    public ProtobufClusterState state() {
        return this.state;
    }
    ...
    */
    public ProtobufClusterState previousState() {
