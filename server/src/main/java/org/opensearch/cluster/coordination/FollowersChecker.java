...
public class FollowersChecker {
    ...
    public FollowersChecker(Settings settings, TransportService transportService,
        ...
        updateFastResponseState(0, Coordinator.Mode.CANDIDATE);
     ...
     */
    public void updateFastResponseState(final long term, final Coordinator.Mode mode) {
    ...
    static class FastResponseState {
        ...
        FastResponseState(final long term, final Coordinator.Mode mode) {
            this.term = term;
            this.mode = mode;
        }
