    ...
    public RoutingNodes(ClusterState clusterState, boolean readOnly) {
        ...
        for (final IndexRoutingTable indexRoutingTable : routingTable.indicesRouting().values()) {
            for (IndexShardRoutingTable indexShard : indexRoutingTable) {
                ...
                /*assert metadata.getIndexSafe(indexShard.shardId().getIndex())
                    .getSettings()
                    .getAsBoolean(IndexMetadata.SETTING_REMOVE_INDEXING_SHARDS, false)
                    || indexShard.primary != null : "Primary shard cannot be null unless remove_indexing_shards is true";*/
