...
public class OperationRouting {
    ...
    public static final Setting<Boolean> STRICT_READ_REPLICA_ROUTING_ENABLED = Setting.boolSetting(
        "cluster.routing.read_replica.strict",
        true,
        Setting.Property.Dynamic,
        Setting.Property.NodeScope
    );
    ...
    public OperationRouting(Settings settings, ClusterSettings clusterSettings) {
        ...
        this.isStrictSearchOnlyShardRouting = STRICT_READ_REPLICA_ROUTING_ENABLED.get(settings);
        ...
        clusterSettings.addSettingsUpdateConsumer(STRICT_READ_REPLICA_ROUTING_ENABLED, this::setStrictSearchOnlyShardRouting);
