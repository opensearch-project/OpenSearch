 ...
 * @opensearch.internal
 */
public class ProtobufIndexNameExpressionResolver {
    private static final DeprecationLogger deprecationLogger = DeprecationLogger.getLogger(ProtobufIndexNameExpressionResolver.class);
    ...
    /**
     * Same as {@link #concreteIndexNames(ProtobufClusterState, IndicesOptions, String...)}, but the index expressions and options
     * are encapsulated in the specified request.
     */
    public String[] concreteIndexNames(ProtobufClusterState state, IndicesRequest request) {
    ...
    /**
     * Same as {@link #concreteIndexNames(ProtobufClusterState, IndicesRequest)}, but access to system indices is always allowed.
     */
    public String[] concreteIndexNamesWithSystemIndexAccess(ProtobufClusterState state, IndicesRequest request) {
        Context context = new Context(state, request.indicesOptions(), false, false, request.includeDataStreams(), true);
        return concreteIndexNames(context, request.indices());
    }

    /**
     * Same as {@link #concreteIndices(ProtobufClusterState, IndicesOptions, String...)}, but the index expressions and options
     * are encapsulated in the specified request and resolves data streams.
     */
    public Index[] concreteIndices(ProtobufClusterState state, IndicesRequest request) {
        Context context = new Context(
            state,
            request.indicesOptions(),
            false,
     ...
     */
    public String[] concreteIndexNames(ProtobufClusterState state, IndicesOptions options, String... indexExpressions) {
    ...
    public String[] concreteIndexNames(ProtobufClusterState state, IndicesOptions options, IndicesRequest request) {
        Context context = new Context(state, options, false, false, request.includeDataStreams(), isSystemIndexAccessAllowed());
        return concreteIndexNames(context, request.indices());
    }

    public List<String> dataStreamNames(ProtobufClusterState state, IndicesOptions options, String... indexExpressions) {
     ...
     * indices options in the context don't allow such a case.
     */
    public Index[] concreteIndices(ProtobufClusterState state, IndicesOptions options, String... indexExpressions) {
     ...
     * indices options in the context don't allow such a case.
     */
    public Index[] concreteIndices(ProtobufClusterState state, IndicesRequest request, long startTime) {
        Context context = new Context(
            state,
            request.indicesOptions(),
            startTime,
     ...
     */
    public Index concreteSingleIndex(ProtobufClusterState state, IndicesRequest request) {
     ...
     */
    public Index concreteWriteIndex(ProtobufClusterState state, IndicesRequest request) {
     ...
     */
    public boolean hasIndexAbstraction(String indexAbstraction, ProtobufClusterState state) {
     ...
     */
    public Set<String> resolveExpressions(ProtobufClusterState state, String... expressions) {
     ...
     */
    public String[] filteringAliases(ProtobufClusterState state, String index, Set<String> resolvedExpressions) {
     ...
     */
    public Map<String, Set<String>> resolveSearchRouting(ProtobufClusterState state, @Nullable String routing, String... expressions) {
    ...
    public static class Context {
        ...
        Context(ProtobufClusterState state, IndicesOptions options, boolean isSystemIndexAccessAllowed) {
        ...
        Context(ProtobufClusterState state, IndicesOptions options, long startTime, boolean isSystemIndexAccessAllowed) {
         ...
         * by {@link #filteringAliases(ProtobufClusterState, String, Set)} since it's the only one that needs aliases
         */
