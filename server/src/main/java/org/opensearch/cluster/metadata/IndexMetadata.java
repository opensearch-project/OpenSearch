...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment, VerifiableWriteable {
    ...
    public boolean equals(Object o) {
        ...
        if (ingestionPaused != that.ingestionPaused) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(ingestionPaused);
        return result;
    }
    ...
    static class IndexMetadataDiff implements Diff<IndexMetadata> {
        ...
        IndexMetadataDiff(IndexMetadata before, IndexMetadata after) {
            ...
            ingestionPaused = after.ingestionPaused;
        }
        ...
        public IndexMetadata apply(IndexMetadata part) {
            ...
            builder.ingestionPaused(ingestionPaused);
    ...
    public static IndexMetadata readFrom(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_3_0_0)) {
            builder.ingestionPaused(in.readBoolean());
        }
        return builder.build();
    }
    ...
    public static class Builder {
        ...
        public Builder(IndexMetadata indexMetadata) {
            ...
            this.ingestionPaused = indexMetadata.ingestionPaused;
        }
