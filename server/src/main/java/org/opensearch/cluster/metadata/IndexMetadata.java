...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment {
    ...
    public static final Setting.AffixSetting<String> INDEX_ROUTING_REQUIRE_GROUP_SETTING =
        Setting.prefixKeySetting(INDEX_ROUTING_REQUIRE_GROUP_PREFIX + ".", key ->
            Setting.simpleString(key, value -> DiscoveryNodeFilters.IP_VALIDATOR.accept(key, value), Property.Dynamic, Property.IndexScope));
    ...
    public static class Builder {
        ...
        public IndexMetadata build() {
            ...
            if (requireMap.isEmpty()) {
                ...
                requireFilters = DiscoveryNodeFilters.buildFromKeyValue(DiscoveryNodeFilters.OpType.AND, requireMap);
            }
            ...
            if (includeMap.isEmpty()) {
                ...
                includeFilters = DiscoveryNodeFilters.buildFromKeyValue(DiscoveryNodeFilters.OpType.OR, includeMap);
            }
            ...
            if (excludeMap.isEmpty()) {
                ...
                excludeFilters = DiscoveryNodeFilters.buildFromKeyValue(DiscoveryNodeFilters.OpType.OR, excludeMap);
            }
            ...
            if (initialRecoveryMap.isEmpty()) {
                ...
                initialRecoveryFilters = DiscoveryNodeFilters.buildFromKeyValue(DiscoveryNodeFilters.OpType.OR, initialRecoveryMap);
            }
     ...
     * {@link OperationRouting#generateShardId(IndexMetadata, String, String)} to route documents
     ...
     * {@link OperationRouting#generateShardId(IndexMetadata, String, String)} to guarantee consistent
