 ...
 * @opensearch.internal
 */
public class ProtobufSearchResponse extends ProtobufActionResponse implements StatusToXContentObject {
    ...
    public ProtobufSearchResponse(byte[] in) throws IOException {
        super(in);
        // TODO: proto message
    ...
    public ProtobufSearchResponse(
        ...
        assert scrollId == null || pointInTimeId == null : "ProtobufSearchResponse can't have both scrollId ["
            + scrollId
            + "] and searchContextId ["
            + pointInTimeId
            + "]";
    ...
    public static ProtobufSearchResponse fromXContent(XContentParser parser) throws IOException {
        ensureExpectedToken(Token.START_OBJECT, parser.nextToken(), parser);
        parser.nextToken();
        return innerFromXContent(parser);
    }

    public static ProtobufSearchResponse innerFromXContent(XContentParser parser) throws IOException {
    ...
    static ProtobufSearchResponse empty(Supplier<Long> tookInMillisSupplier, Clusters clusters) {
