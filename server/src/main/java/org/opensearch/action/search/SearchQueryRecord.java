 ...
 * @opensearch.internal
 */
public abstract class SearchQueryRecord <T extends Number & Comparable<T>> implements Comparable<SearchQueryRecord<T>>, Writeable, ToXContentObject {
    ...
    public SearchQueryRecord(final StreamInput in) throws IOException {
        this.timestamp = in.readLong();
        this.searchType = SearchType.fromString(in.readString().toLowerCase());
