 ...
 * @opensearch.internal
 */
public class ProtobufSearchRequest extends ProtobufActionRequest implements IndicesRequest.Replaceable {
     ...
     */
    public ProtobufSearchRequest(ProtobufSearchRequest searchRequest) {
        this(
            searchRequest,
     ...
     */
    public ProtobufSearchRequest(String... indices) {
     ...
     */
    public ProtobufSearchRequest(String[] indices, SearchSourceBuilder source) {
        this();
        if (source == null) {
     ...
     * Used when a {@link ProtobufSearchRequest} is created and executed as part of a cross-cluster search request
     ...
     */
    static ProtobufSearchRequest subSearchRequest(
        ...
        return new ProtobufSearchRequest(originalSearchRequest, indices, clusterAlias, absoluteStartMillis, finalReduce);
    }

    private ProtobufSearchRequest(
     ...
     */
    public ProtobufSearchRequest(byte[] in) throws IOException {
        super(in);
        // TODO: proto message
        searchType = null;
        indices = null;
     ...
     * request. When created through {@link #subSearchRequest(ProtobufSearchRequest, String[], String, long, boolean)}, this method returns
     ...
     */
    @Override
    public ProtobufSearchRequest indices(String... indices) {
        validateIndices(indices);
        this.indices = indices;
        return this;
    }
    ...
    public ProtobufSearchRequest indicesOptions(IndicesOptions indicesOptions) {
     ...
     * A comma separated list of routing values to control the shards the search will be executed on.
     */
    public ProtobufSearchRequest routing(String routing) {
     ...
     */
    public ProtobufSearchRequest routing(String... routings) {
     ...
     */
    public ProtobufSearchRequest preference(String preference) {
     ...
     */
    public ProtobufSearchRequest searchType(SearchType searchType) {
     ...
     */
    public ProtobufSearchRequest searchType(String searchType) {
     ...
     */
    public ProtobufSearchRequest source(SearchSourceBuilder sourceBuilder) {
     ...
     * If set, will enable scrolling of the search request.
     */
    public ProtobufSearchRequest scroll(Scroll scroll) {
        this.scroll = scroll;
        return this;
    }
     ...
     */
    public ProtobufSearchRequest scroll(TimeValue keepAlive) {
     ...
     * If set, will enable scrolling of the search request for the specified timeout.
     */
    public ProtobufSearchRequest scroll(String keepAlive) {
     ...
     */
    public ProtobufSearchRequest requestCache(Boolean requestCache) {
     ...
     */
    public ProtobufSearchRequest allowPartialSearchResults(boolean allowPartialSearchResults) {
    ...
    public ProtobufSearchRequest pipeline(String pipeline) {
    ...
    @Override
    public ProtobufSearchTask createProtobufTask(long id, String type, String action, ProtobufTaskId parentTaskId, Map<String, String> headers) {
        return new ProtobufSearchTask(id, type, action, this::buildDescription, parentTaskId, headers, cancelAfterTimeInterval);
    }
    ...
    public boolean equals(Object o) {
        ...
        ProtobufSearchRequest that = (ProtobufSearchRequest) o;
