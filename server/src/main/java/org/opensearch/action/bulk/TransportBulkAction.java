...
public class TransportBulkAction extends HandledTransportAction<BulkRequest, BulkResponse> {
    ...
    protected void doInternalExecute(Task task, BulkRequest bulkRequest, String executorName, ActionListener<BulkResponse> listener) {
        ...
        TransportBulkActionHelper.requestsValidation(bulkRequest.requests, minNodeVersion);

        boolean hasIndexRequestsWithPipelines = TransportBulkActionHelper.resolvePipelines(bulkRequest.requests, metadata);
            ...
            try {
                if (Assertions.ENABLED) {
                    final boolean arePipelinesResolved = bulkRequest.requests()
                        .stream()
                        .map(TransportBulkActionHelper::getIndexWriteRequest)
    ...
    static final class BulkRequestModifier implements Iterator<DocWriteRequest<?>> {
        ...
        synchronized void markItemAsDropped(int slot) {
            IndexRequest indexRequest = TransportBulkActionHelper.getIndexWriteRequest(bulkRequest.requests().get(slot));
