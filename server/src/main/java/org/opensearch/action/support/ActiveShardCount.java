...
public final class ActiveShardCount extends ShardCount {
    ...
    /**
     * Returns an {@link ActiveShardCount} equivalent to the given {@link ShardCount}.
     */
    public static ActiveShardCount of(final ShardCount shardCount) {
        return get(shardCount.getValue());
    }
