...
public final class ActiveShardCount extends ShardCount {
    ...
    public static ActiveShardCount get(final int value) {
        switch (value) {
    ...
    public boolean enoughShardsActive(final ClusterState clusterState, final String... indices) {
        ...
        for (final String indexName : indices) {
            ...
            if (waitForActiveShards == ActiveShardCount.DEFAULT) {
                waitForActiveShards = ActiveShardCount.get(SETTING_WAIT_FOR_ACTIVE_SHARDS.get(indexMetadata.getSettings()).getValue());
            }
