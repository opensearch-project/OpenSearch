...
public abstract class TransportClusterManagerNodeExtendedAction<
    ...
    protected TransportClusterManagerNodeExtendedAction(
        String actionName,
        TransportService transportService,
        ClusterService clusterService,
        ThreadPool threadPool,
        ActionFilters actionFilters,
        Writeable.Reader<ClusterManagerNodeAckRequest> request,
    ...
    /**
     * @deprecated As of 2.2, because supporting inclusive language, replaced by {@link #clusterManagerOperation(ClusterManagerNodeAckRequest, ClusterState, ActionListener)}
     */
    @Deprecated
     ...
     * @deprecated As of 2.2, because supporting inclusive language, replaced by {@link #clusterManagerOperation(Task, ClusterManagerNodeAckRequest, ClusterState, ActionListener)}
     */
    @Deprecated
    ...
    @Override
    protected void doExecute(Task task, final ClusterManagerNodeAckRequest request, ActionListener<Response> listener) {
        if (task != null) {
    ...
    class AsyncSingleAction extends RetryableAction {
        ...
        AsyncSingleAction(Task task, ClusterManagerNodeAckRequest request, ActionListener<Response> listener) {
            super(
                logger,
                threadPool,
        ...
        private void executeOnClusterManager(DiscoveryNode clusterManagerNode, ClusterState clusterState) {
            ...
            transportService.sendRequest(
                ...
                actionName,
                request,
                new ActionListenerResponseHandler<Response>(listener, TransportClusterManagerNodeExtendedAction.this::read) {
                    @Override
