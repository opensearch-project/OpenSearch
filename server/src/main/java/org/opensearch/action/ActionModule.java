...
import org.opensearch.action.admin.cluster.catalog.TransportPublishIndexAction;
import org.opensearch.action.admin.cluster.catalog.GetPublishStatusAction;
import org.opensearch.action.admin.cluster.catalog.TransportGetPublishStatusAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(PublishIndexAction.INSTANCE, TransportPublishIndexAction.class);
        actions.register(GetPublishStatusAction.INSTANCE, TransportGetPublishStatusAction.class);
