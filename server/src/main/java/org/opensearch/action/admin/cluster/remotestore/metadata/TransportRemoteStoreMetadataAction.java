...
public class TransportRemoteStoreMetadataAction extends TransportAction<RemoteStoreMetadataRequest, RemoteStoreMetadataResponse> {
            ...
            for (String indexName : concreteIndices) {
                ...
                for (int shardId : shardIds) {
                    try {
                        ...
                        Map<String, Object> segmentMetadataMap = getSegmentMetadata(
    ...
    private Map<String, Object> getTranslogMetadata(IndexMetadata indexMetadata, ShardId shardId, IndexService indexService)
        throws IOException {
