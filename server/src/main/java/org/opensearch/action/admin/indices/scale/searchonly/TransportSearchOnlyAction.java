...
public class TransportSearchOnlyAction extends TransportClusterManagerNodeAction<SearchOnlyRequest, AcknowledgedResponse> {
    ...
    private void proceedWithScaleDown(
        ...
        searchOnlyShardSyncManager.sendShardSyncRequests(
            index,
            primaryShardsNodes,
            ActionListener.wrap(responses -> handleShardSyncResponses(responses, index, blockedIndices, listener), listener::onFailure)
        );
    }
    ...
    private void handleShardSyncResponses(
        ...
        searchOnlyShardSyncManager.validateNodeResponses(
            responses,
            ActionListener.wrap(searchOnlyResponse -> finalizeScaleDown(index, blockedIndices, listener), listener::onFailure)
        );
    }
     ...
     */
    private void finalizeScaleDown(String index, Map<Index, ClusterBlock> blockedIndices, ActionListener<AcknowledgedResponse> listener) {
    ...
    private class AddBlockClusterStateUpdateTask extends ClusterStateUpdateTask {
        ...
        public void clusterStateProcessed(String source, ClusterState oldState, ClusterState newState) {
            ...
            if (indexMetadata != null) {
                ...
                proceedWithScaleDown(index, primaryShardsNodes, blockedIndices, listener);
            }
        }
