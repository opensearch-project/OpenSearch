 ...
 * and JSON rendering for the {@code native_metrics} section of the
 * nodes-stats API response.
 *
 * @opensearch.internal
 */
public class NativeMetricsStats implements Writeable, ToXContentFragment {

    private final DataFusionPluginStats dataFusionPluginStats;

    public NativeMetricsStats(DataFusionPluginStats stats) {
        this.dataFusionPluginStats = Objects.requireNonNull(stats);
    }

    public NativeMetricsStats(StreamInput in) throws IOException {
        ...
        this.dataFusionPluginStats = new DataFusionPluginStats(ioRuntime, cpuRuntime, queryExecution, streamNext, fetchPhase, segmentStats);
    }
    ...
    public boolean equals(Object o) {
        ...
        NativeMetricsStats that = (NativeMetricsStats) o;
