...
public class ClusterHealthResponse extends ActionResponse implements StatusToXContentObject {
    ...
    private static final String DISCOVERED_CLUSTER_MANAGER = "discovered_master";
    ...
    static {
        ...
        PARSER.declareBoolean(constructorArg(), new ParseField(DISCOVERED_CLUSTER_MANAGER));
