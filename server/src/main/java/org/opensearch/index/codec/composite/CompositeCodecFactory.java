...
public class CompositeCodecFactory {
    ...
    public Map<String, Codec> getCompositeIndexCodecs(MapperService mapperService, Logger logger) {
        ...
        codecs.put(DEFAULT_CODEC, new Composite103Codec(Lucene104Codec.Mode.BEST_SPEED, mapperService, logger));
        codecs.put(LZ4, new Composite103Codec(Lucene104Codec.Mode.BEST_SPEED, mapperService, logger));
        codecs.put(BEST_COMPRESSION_CODEC, new Composite103Codec(Lucene104Codec.Mode.BEST_COMPRESSION, mapperService, logger));
        codecs.put(ZLIB, new Composite103Codec(Lucene104Codec.Mode.BEST_COMPRESSION, mapperService, logger));
        return codecs;
    }
}
