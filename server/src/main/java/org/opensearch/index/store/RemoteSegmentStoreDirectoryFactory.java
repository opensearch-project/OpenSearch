...
/**
 * Factory for a remote store directory with format-aware capabilities.
 * Creates RemoteSegmentStoreDirectory instances using CompositeRemoteDirectory
 * for multi-format support in remote storage.
 *
 * @opensearch.api
 */
...
public class RemoteSegmentStoreDirectoryFactory implements IndexStorePlugin.DirectoryFactory {
    ...
    /**
     * Constructor for backward compatibility without PluginsService
     */
    ...
    /**
     * Constructor with PluginsService for format discovery
     */
    public RemoteSegmentStoreDirectoryFactory(
        Supplier<RepositoriesService> repositoriesService,
        ThreadPool threadPool,
    ...
    /**
     * Creates a new RemoteSegmentStoreDirectory with CompositeRemoteDirectory for format-aware operations
     */
