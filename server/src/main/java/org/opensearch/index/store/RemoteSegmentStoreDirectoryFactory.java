...
public class RemoteSegmentStoreDirectoryFactory implements IndexStorePlugin.DirectoryFactory {
    ...
    public Directory newDirectory(String repositoryName, String indexUUID, ShardId shardId, RemoteStorePathStrategy pathStrategy)
        ...
        try (Repository repository = repositoriesService.get().repository(repositoryName)) {
            ...
            RemoteStorePathStrategy.RemoteStorePathInput dataPathInput = RemoteStorePathStrategy.RemoteStorePathInput.builder()
            ...
            RemoteStorePathStrategy.RemoteStorePathInput mdPathInput = RemoteStorePathStrategy.RemoteStorePathInput.builder()
                .basePath(repositoryBasePath)
                .indexUUID(indexUUID)
                .shardId(shardIdStr)
                .dataCategory(SEGMENTS)
