        ...
        synchronized (syncLock) {
            try (ReleasableLock toClose = writeLock.acquire()) {
                synchronized (this) {
                    ...
                    Long translogWithFooterChecksum = null;
                    try {
                        ...
                        if (header.getTranslogHeaderVersion() >= TranslogHeader.VERSION_WITH_FOOTER) {
                            ...
                            translogWithoutFooterChecksum = translogCheckedContainer.getChecksum();
                            ...
                            translogWithFooterChecksum = translogCheckedContainer.getChecksum();
                        } else {
