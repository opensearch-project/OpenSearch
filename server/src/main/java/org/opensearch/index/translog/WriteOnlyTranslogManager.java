...
public class WriteOnlyTranslogManager extends InternalTranslogManager {
    ...
    public WriteOnlyTranslogManager(EngineConfig engineConfig, ShardId shardId, ReleasableLock readLock, LocalCheckpointTracker tracker, String translogUUID, TranslogEventListener translogEventListener, Runnable ensureOpen, BiConsumer<String, Exception> failEngine, Function<AlreadyClosedException, Boolean> failOnTragicEvent) throws IOException {
    ...
    @Override
    public void recoverFromTranslog(Engine engine, TranslogRecoveryRunner translogRecoveryRunner, long localCheckpoint, long recoverUpToSeqNo, Runnable flush) throws IOException {
