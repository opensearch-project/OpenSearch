...
import org.opensearch.index.engine.exec.bridge.lucene.EngineConfigConfigurationProvider;
import org.opensearch.index.engine.exec.bridge.lucene.LuceneIndexCommitData;
...
public abstract class Engine implements LifecycleAware, Closeable, Indexer, CheckpointState, StatsHolder, IndexingThrottler, OperationMapper {
    ...
    protected Engine(EngineConfig engineConfig) {
        ...
        this.configurationProvider = new EngineConfigConfigurationProvider(engineConfig);
    }
    ...
    public GatedCloseable<CommitData> acquireSafeCommit() throws EngineException {
        GatedCloseable<IndexCommit> commit = acquireSafeIndexCommit();
        return new GatedCloseable<>(new LuceneIndexCommitData(commit.get()), commit::close);
    }
