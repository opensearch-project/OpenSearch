...
public abstract class Engine implements LifecycleAware, Closeable {
    ...
    public static class DeleteResult extends Result {
        ...
        public DeleteResult(long version, long term, long seqNo, boolean found) {
            this(version, term, seqNo, found, null);
        }

        public DeleteResult(long version, long term, long seqNo, boolean found, InternalEngine.DeletionStrategy deletionStrategy) {
        ...
        public InternalEngine.DeletionStrategy deletionStrategy() {
