...
public interface DocumentIndexWriter extends Closeable {
    ...
    long addDocuments(Iterable<? extends Iterable<? extends IndexableField>> docs, Term uid)
        throws IOException;
    ...
    void deleteDocument(Term uid, boolean isStaleOperation, Iterable<? extends IndexableField> doc, long version, long seqNo, long primaryTerm, Field... softDeletesField) throws IOException;
