 ...
 * <p>
 * One context per collector leaf in the {@link IndexFilterTree}. Each leaf
...
public class IndexFilterTreeContext<C extends IndexFilterContext> implements Closeable {
     ...
     * @param leafContexts one context per collector leaf
     */
    ...
    /** Returns the context for the given collector leaf. */
    public C leafContext(int leafIndex) {
        return leafContexts.get(leafIndex);
    }

    /** Returns the number of collector leaf contexts. */
