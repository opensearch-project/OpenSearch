...
public abstract class GeoShapeValue {
     ...
     */
    public abstract GeometryDocValue nextValue() throws IOException;
    ...
    public static class EmptyGeoShapeValue extends GeoShapeValue {
         ...
         */
        @Override
        public GeometryDocValue nextValue() throws IOException {
    ...
    public static class MissingGeoShapeValue extends GeoShapeValue {
        ...
        private GeometryDocValue geometryDocValue;
        ...
        public GeometryDocValue nextValue() throws IOException {
            if (useMissingGeoShapeValue) {
                if (geometryDocValue == null) {
                    // keeping geometryDocValue cache so that it can be reused.
                    geometryDocValue = GeometryDocValue.createGeometryDocValue(missing);
                }
                return geometryDocValue;
            }
    ...
    public static class StandardGeoShapeValue extends GeoShapeValue {
        ...
        public GeometryDocValue nextValue() throws IOException {
            ...
            return new GeometryDocValue(fieldName, bytesRef);
        }
    }
}
