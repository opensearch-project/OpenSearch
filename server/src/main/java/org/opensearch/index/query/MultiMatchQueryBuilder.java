...
public class MultiMatchQueryBuilder extends AbstractQueryBuilder<MultiMatchQueryBuilder> {
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        ...
        if (fuzzyRewrite != null) {
            multiMatchQuery.setFuzzyRewriteMethod(QueryParsers.parseRewriteMethod(fuzzyRewrite, FuzzyQuery.defaultRewriteMethod(maxExpansions), LoggingDeprecationHandler.INSTANCE));
        }
        if (tieBreaker != null) {
