        ...
        if (context.docMapper() != null && context.docMapper().mappers() != null) {
            ...
            if (mapper != null) {
                ...
                if (script != null) {
                    ...
                    Map<String, Object> namespaceContext = doc.getGroupingCriteriaParams();
                    String namespace = groupingFieldMapper.fieldType()
                        .fields()
                        .stream()
                        .map(field -> namespaceContext.get(field).toString())
                        .collect(Collectors.joining("-"));
                    doc.setGroupingCriteria(namespace);
                }
            }
        }
    }
