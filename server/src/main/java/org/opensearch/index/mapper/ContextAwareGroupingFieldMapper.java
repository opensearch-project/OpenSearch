...
/**
 * A field mapper to specify namespace creation
 *
 * @opensearch.internal
 */
public class ContextAwareGroupingFieldMapper extends ParametrizedFieldMapper {

    public static final String CONTENT_TYPE = "context-aware-grouping";
    ...
    private static class TypeParser implements Mapper.TypeParser {
        ...
        public Mapper.Builder<?> parse(String name, Map<String, Object> node, ParserContext context, ObjectMapper.Builder objBuilder)
            ...
            if (builder.fields.isConfigured() == false) {
                throw new MapperParsingException("[fields] in context-aware-grouping is required");
            }
    ...
    public static class Builder extends ParametrizedFieldMapper.Builder {
        ...
        private final Parameter<List<String>> fields = new Parameter<>("fields", true, Collections::emptyList, (n, c, o) -> {
            ...
            if (fields.isEmpty()) {
                throw new MapperParsingException("Expected [fields] in context-aware-grouping to have one value");
            }

            if (fields.size() > 1) {
                throw new MapperParsingException("Currently [fields] in context-aware-grouping does not support multiple values");
            }
    ...
    protected void parseCreateField(ParseContext context) throws IOException {
        throw new MapperParsingException("context-aware-grouping cannot be ingested in the document");
    }
