...
public class RootObjectMapper extends ObjectMapper {
    ...
    public static class TypeParser extends ObjectMapper.TypeParser {
        ...
        public Mapper.Builder parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
            ...
            while (iterator.hasNext()) {
                ...
                if (fieldName.equals("composite")) {
                    ...
                    iterator.remove();
                } else if (fieldName.equals(NamespaceFieldMapper.CONTENT_TYPE)) {
        ...
        protected static void parseNamespaceField(ObjectMapper.Builder objBuilder, Map<String, Object> namespaceNode, ParserContext parserContext) {
            ...
            Mapper.Builder<?> mapperBuilder = typeParser.parse(NamespaceFieldMapper.CONTENT_TYPE, namespaceNode, parserContext, objBuilder);
