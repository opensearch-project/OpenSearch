...
public class DerivedFieldType extends MappedFieldType implements GeoShapeQueryable {
    ...
    public Query termQuery(Object value, QueryShardContext context) {
        ...
        TextFieldMapper.TextFieldType sourceIndexedFieldType = getSourceIndexedFieldType(derivedField.getSourceIndexedField(), context);
        ...
        return new DerivedFieldQuery(query, filterQuery, valueFetcher, context.lookup(), getIndexAnalyzer(), indexableFieldGenerator);
    }
    ...
    public Query rangeQuery(
        ...
        DerivedFieldValueFetcher valueFetcher = valueFetcher(context, context.lookup(), null);
        return new DerivedFieldQuery(query, valueFetcher, context.lookup(), getIndexAnalyzer(), indexableFieldGenerator);
    }
