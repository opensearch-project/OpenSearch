...
public abstract class FieldMapper extends Mapper implements Cloneable {
    ...
    public void parse(ParseContext context) throws IOException {
        try {
            ...
            extractNamespaceContext(context);
        } catch (Exception e) {
    ...
    private void extractNamespaceContext(ParseContext context) throws IOException {
        ...
        if (mapper != null) {
            ...
            if (namespaceMapper.fieldType().fields().contains(name())) {
               context.doc().addNamespaceContext(name(), getFieldValue(context));
            }
        }
    }

    protected Object getFieldValue(ParseContext context) throws IOException {
        throw new  UnsupportedOperationException("getFieldValue not implemented for the field mapper [" + this.getClass().getSimpleName() + "]");
    }
