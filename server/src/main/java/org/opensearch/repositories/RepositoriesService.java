...
import static org.opensearch.cluster.service.ClusterManagerTaskConfigurations.TaskKeys.DELETE_REPOSITORY_KEY;
import static org.opensearch.cluster.service.ClusterManagerTaskConfigurations.TaskKeys.PUT_REPOSITORY_KEY;
...
public class RepositoriesService extends AbstractLifecycleComponent implements ClusterStateApplier {
    ...
    public RepositoriesService(
        ...
        putRepositoryTaskKey = clusterService.registerClusterManagerTask(PUT_REPOSITORY_KEY, true);
        deleteRepositoryTaskKey = clusterService.registerClusterManagerTask(DELETE_REPOSITORY_KEY, true);
    }
