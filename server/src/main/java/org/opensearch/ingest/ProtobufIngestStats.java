...
* @opensearch.internal
*/
public class ProtobufIngestStats implements ProtobufWriteable, ToXContentFragment {
    ...
    */
    public ProtobufIngestStats(Stats totalStats, List<PipelineStat> pipelineStats, Map<String, List<ProcessorStat>> processorStats) {
     ...
     * Read from a stream.
    */
    public ProtobufIngestStats(CodedInputStream in) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int processorsSize = in.readInt32();
    ...
    public void writeTo(CodedOutputStream out) throws IOException {
        ...
        out.writeInt32NoTag(pipelineStats.size());
        for (PipelineStat pipelineStat : pipelineStats) {
            out.writeStringNoTag(pipelineStat.getPipelineId());
            ...
            if (processorStatsForPipeline == null) {
                ...
                out.writeInt32NoTag(processorStatsForPipeline.size());
                for (ProcessorStat processorStat : processorStatsForPipeline) {
                    out.writeStringNoTag(processorStat.getName());
                    out.writeStringNoTag(processorStat.getType());
    ...
    public boolean equals(Object o) {
        ...
        ProtobufIngestStats that = (ProtobufIngestStats) o;
    ...
    public static class Stats implements ProtobufWriteable, ToXContentFragment {
        ...
        */
        public Stats(CodedInputStream in) throws IOException {
            ingestCount = in.readInt64();
            ingestTimeInMillis = in.readInt64();
            ingestCurrent = in.readInt64();
            ingestFailedCount = in.readInt64();
        }

        @Override
        public void writeTo(CodedOutputStream out) throws IOException {
            out.writeInt64NoTag(ingestCount);
            out.writeInt64NoTag(ingestTimeInMillis);
            out.writeInt64NoTag(ingestCurrent);
            out.writeInt64NoTag(ingestFailedCount);
        }
        ...
        */
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (o == null || getClass() != o.getClass()) return false;
            ProtobufIngestStats.Stats that = (ProtobufIngestStats.Stats) o;
    ...
    */
    static class Builder {
        ...
        Builder addTotalMetrics(IngestMetric totalMetric) {
            this.totalStats = totalMetric.createProtobufStats();
            return this;
        }

        Builder addPipelineMetrics(String pipelineId, IngestMetric pipelineMetric) {
            this.pipelineStats.add(new PipelineStat(pipelineId, pipelineMetric.createProtobufStats()));
            return this;
        }
        ...
        Builder addProcessorMetrics(String pipelineId, String processorName, String processorType, IngestMetric metric) {
            this.processorStats.computeIfAbsent(pipelineId, k -> new ArrayList<>())
                .add(new ProcessorStat(processorName, processorType, metric.createProtobufStats()));
            return this;
        }

        ProtobufIngestStats build() {
            return new ProtobufIngestStats(
                totalStats,
                Collections.unmodifiableList(pipelineStats),
    ...
    */
    public static class PipelineStat {
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (o == null || getClass() != o.getClass()) return false;
            ProtobufIngestStats.PipelineStat that = (ProtobufIngestStats.PipelineStat) o;
    ...
    */
    public static class ProcessorStat {
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (o == null || getClass() != o.getClass()) return false;
            ProtobufIngestStats.ProcessorStat that = (ProtobufIngestStats.ProcessorStat) o;
