...
import static org.opensearch.cluster.service.ClusterManagerTaskConfigurations.TaskKeys.DELETE_PIPELINE_KEY;
import static org.opensearch.cluster.service.ClusterManagerTaskConfigurations.TaskKeys.PUT_PIPELINE_KEY;
...
public class IngestService implements ClusterStateApplier, ReportingService<IngestInfo> {
    ...
    public IngestService(
        ...
        putPipelineTaskKey = clusterService.registerClusterManagerTask(PUT_PIPELINE_KEY, true);
        deletePipelineTaskKey = clusterService.registerClusterManagerTask(DELETE_PIPELINE_KEY, true);
