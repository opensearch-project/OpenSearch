    ...
    public static InFlightShardSnapshotStates forRepo(String repoName, List<SnapshotsInProgress.Entry> snapshots) {
        ...
        for (SnapshotsInProgress.Entry runningSnapshot : snapshots) {
            ...
            if (runningSnapshot.isClone()) {
                for (Map.Entry<RepositoryShardId, SnapshotsInProgress.ShardSnapshotStatus> clone : runningSnapshot.clones().entrySet()) {
                ...
                for (Map.Entry<ShardId, SnapshotsInProgress.ShardSnapshotStatus> shard : runningSnapshot.shards().entrySet()) {
