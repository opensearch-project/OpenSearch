...
public class ExtensionNamedWriteableRegistry {
     ...
     *
     * @param extensions List of DiscoveryExtensions to send requests to
     * @param transportService Service that facilitates transport requests
     */
    public ExtensionNamedWriteableRegistry(List<DiscoveryExtensionNode> extensions, TransportService transportService) {
    ...
    public void getNamedWriteables() {
        ...
        for (DiscoveryNode extensionNode : extensions) {
            try {
