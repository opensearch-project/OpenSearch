...
import org.opensearch.action.admin.cluster.node.stats.NativeMetricsStats;
...
public class NodeService implements Closeable {
    ...
    public NodeStats stats(
        ...
        DataFusionPluginStats dataFusionPluginStats = (nativeMetrics && dataFusionService != null) ? dataFusionService.getOrRefresh() : null;
        NativeMetricsStats nativeMetricsStats = (dataFusionPluginStats != null) ? new NativeMetricsStats(dataFusionPluginStats) : null;
