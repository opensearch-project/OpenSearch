...
/**
 * Represents the latest checkpoint for a shard.  ReplicationCheckpoints are sent from primary shards to replicas
 * so that replicas can fetch segments for a particular checkpoint.
 *
 * @opensearch.internal
 */
