...
public class PartitionedBlockingQueueContainer {
    ...
    public void add(IngestionShardConsumer.ReadResult<? extends IngestionShardPointer, ? extends Message> readResult)
        ...
        String id = (String) payloadMap.computeIfAbsent(ID, key -> IngestionUtils.generateID());
        ShardUpdateMessage updateMessage = new ShardUpdateMessage(readResult.getPointer(), readResult.getMessage(), payloadMap);
