...
public class SearchPipelineService implements ClusterStateApplier, ReportingService<SearchPipelineInfo> {
    ...
    /**
     * Specify the system generated factory type to disable them so that we will not try to evaluate if we should use
     * them to generate search processors for the search request. Or can use a wildcard * to disable all.
     */
    public static final Setting<List<String>> DISABLED_SYSTEM_GENERATED_FACTORIES_SETTING = Setting.listSetting(
        "cluster.search.disabled_system_generated_factories",
        List.of(),
        s -> s,
        Setting.Property.Dynamic,
        Setting.Property.NodeScope
    );
    private volatile List<String> disabledSystemGeneratedFactories;
    ...
    public SearchPipelineService(
        ...
        clusterService.getClusterSettings()
            .addSettingsUpdateConsumer(DISABLED_SYSTEM_GENERATED_FACTORIES_SETTING, this::setDisabledSystemGeneratedFactories);
        setDisabledSystemGeneratedFactories(clusterService.getClusterSettings().get(DISABLED_SYSTEM_GENERATED_FACTORIES_SETTING));
    }

    private void setDisabledSystemGeneratedFactories(List<String> disabledSystemGeneratedFactories) {
        this.disabledSystemGeneratedFactories = disabledSystemGeneratedFactories;
    }
    ...
    public PipelinedRequest resolvePipeline(SearchRequest searchRequest, IndexNameExpressionResolver indexNameExpressionResolver)
        ...
        final SystemGeneratedPipelineHolder systemGeneratedPipelineHolder = SystemGeneratedPipelineWithMetrics.create(
            ...
            disabledSystemGeneratedFactories
        );
