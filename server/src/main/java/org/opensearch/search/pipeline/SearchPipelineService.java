...
public class SearchPipelineService implements ClusterStateApplier, ReportingService<SearchPipelineInfo> {
    ...
    private void setEnabledSystemGeneratedFactories(List<String> disabledSystemGeneratedFactories) {
        this.enabledSystemGeneratedFactories = disabledSystemGeneratedFactories;
    }
