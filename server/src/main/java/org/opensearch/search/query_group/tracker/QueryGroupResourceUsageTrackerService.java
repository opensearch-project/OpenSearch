...
import org.opensearch.search.query_group.QueryGroupService;
...
/**
 * This class tracks requests per QueryGroups
 */
public class QueryGroupResourceUsageTrackerService
    implements
        TaskManager.TaskEventListeners,
        QueryGroupResourceUsageTracker,
        QueryGroupRequestCanceller,
        QueryGroupPruner {
    ...
    /**
     * QueryGroup ids which are marked for deletion in between the
     * {@link QueryGroupService} runs
     */
    private List<String> toDeleteQueryGroups;
    private List<Object> activeQueryGroups;
    private final TaskManager taskManager;
    private final TaskResourceTrackingService taskResourceTrackingService;

    /**
     * QueryGroupResourceUsageTrackerService constructor
     * @param taskManager
     * @param taskResourceTrackingService
     */
    @Inject
    public QueryGroupResourceUsageTrackerService(TaskManager taskManager, TaskResourceTrackingService taskResourceTrackingService) {
        this.taskManager = taskManager;
        this.taskResourceTrackingService = taskResourceTrackingService;
        toDeleteQueryGroups = Collections.synchronizedList(new ArrayList<>());
     ...
     */
    public void pruneQueryGroup() {
        toDeleteQueryGroups = toDeleteQueryGroups.stream().filter(this::hasUnfinishedTasks).collect(Collectors.toList());
    }
    ...
    public void deleteSandbox(String sandboxId) {
        if (hasUnfinishedTasks(sandboxId)) {
            toDeleteQueryGroups.add(sandboxId);
        }
