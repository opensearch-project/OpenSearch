...
public class StreamingSearchMetrics {
    ...
    public void recordSuccess(StreamingSearchContext context) {
        ...
        if (context.firstResultTime > 0) {
            ...
            if (timeToFirstResultHistogram != null) {
                timeToFirstResultHistogram.record(timeToFirst, Tags.create().addTag("index", context.index));
            }
        }
     ...
     */
    public void recordBlockProcessing(int docsEvaluated, int docsSkipped, int blocksProcessed, int blocksSkipped) {
    ...
    public static class StreamingSearchStats {
        ...
        StreamingSearchStats(StreamingSearchMetrics metrics) {
            ...
            this.skipRatio = totalBlocks > 0 ? (double) metrics.totalBlocksSkipped.sum() / totalBlocks : 0;
