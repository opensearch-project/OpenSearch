...
public class MovingFunctions {
    ...
    /**
     * Version of holt that can "forecast", not exposed as a allowlisted function for moving_fn scripts, but
    ...
    /**
     * Version of holt-winters that can "forecast", not exposed as a allowlisted function for moving_fn scripts, but
     * here as compatibility/code sharing for existing moving_avg agg.  Can be removed when moving_avg is gone.
     */
