...
public class ContextAwareCriteriaQueryExtraction {
    ...
    public Set<String> extractCriteria(QueryBuilder queryBuilder) {
        ...
        switch (queryBuilder) {
            case FilterAwareQueryBuilder withFilterQueryBuilder -> {
    ...
    private Set<String> extractCriteriaFromBooleanQuery(BoolQueryBuilder boolQueryBuilder) {
        ...
        int minimumShouldMatch = minimumShouldMatch(minshouldMatchString);
    ...
    private int minimumShouldMatch(String minshouldMatchString) {
        int minShouldMatch = 1;
        if (minshouldMatchString != null) {
            try {
                minShouldMatch = Integer.parseInt(minshouldMatchString);
            } catch (NumberFormatException e) {
                // Handle invalid number format, keep default value of 1
            }
        }
