...
* @opensearch.internal
*/
public class ProtobufOsStats implements ProtobufWriteable, ToXContentFragment {
    ...
    public ProtobufOsStats(final long timestamp, final Cpu cpu, final Mem mem, final Swap swap, final Cgroup cgroup) {
    ...
    public ProtobufOsStats(CodedInputStream in) throws IOException {
        ProtobufStreamInput protobufStreamInput = new ProtobufStreamInput(in);
        this.timestamp = in.readInt64();
        this.cpu = new Cpu(in);
        this.mem = new Mem(in);
        this.swap = new Swap(in);
        this.cgroup = protobufStreamInput.readOptionalWriteable(Cgroup::new);
    }
    ...
    public void writeTo(CodedOutputStream out) throws IOException {
        ...
        mem.writeTo(out);
        swap.writeTo(out);
        protobufStreamOutput.writeOptionalWriteable(cgroup);
    }
    ...
    * @opensearch.internal
    */
    public static class Cpu implements ProtobufWriteable, ToXContentFragment {
        ...
        public Cpu(CodedInputStream in) throws IOException {
            ProtobufStreamInput protobufStreamInput = new ProtobufStreamInput(in);
            this.percent = protobufStreamInput.readShort();
            if (in.readBool()) {
                this.loadAverage = protobufStreamInput.readDoubleArray();
            } else {
        ...
        public void writeTo(CodedOutputStream out) throws IOException {
            ...
            if (loadAverage == null) {
                ...
                protobufStreamOutput.writeDoubleArray(loadAverage);
            }
        }
    ...
    * @opensearch.internal
    */
    public static class Swap implements ProtobufWriteable, ToXContentFragment {
        ...
        public Swap(CodedInputStream in) throws IOException {
            this.total = in.readInt64();
            assert total >= 0 : "expected total swap to be positive, got: " + total;
            this.free = in.readInt64();
            assert free >= 0 : "expected free swap to be positive, got: " + total;
        }
    ...
    * @opensearch.internal
    */
    public static class Mem implements ProtobufWriteable, ToXContentFragment {
    ...
    * @opensearch.internal
    */
    public static class Cgroup implements ProtobufWriteable, ToXContentFragment {
        ...
        */
        ...
        Cgroup(final CodedInputStream in) throws IOException {
            ProtobufStreamInput protobufStreamInput = new ProtobufStreamInput(in);
            cpuAcctControlGroup = in.readString();
            cpuAcctUsageNanos = in.readInt64();
            cpuControlGroup = in.readString();
            cpuCfsPeriodMicros = in.readInt64();
            cpuCfsQuotaMicros = in.readInt64();
            cpuStat = new CpuStat(in);
            memoryControlGroup = protobufStreamInput.readOptionalString();
            memoryLimitInBytes = protobufStreamInput.readOptionalString();
            memoryUsageInBytes = protobufStreamInput.readOptionalString();
        }

        @Override
        public void writeTo(final CodedOutputStream out) throws IOException {
            ProtobufStreamOutput protobufStreamOutput = new ProtobufStreamOutput(out);
            out.writeStringNoTag(cpuAcctControlGroup);
            out.writeInt64NoTag(cpuAcctUsageNanos);
            out.writeStringNoTag(cpuControlGroup);
            out.writeInt64NoTag(cpuCfsPeriodMicros);
            out.writeInt64NoTag(cpuCfsQuotaMicros);
            cpuStat.writeTo(out);
            protobufStreamOutput.writeOptionalString(memoryControlGroup);
            protobufStreamOutput.writeOptionalString(memoryLimitInBytes);
            protobufStreamOutput.writeOptionalString(memoryUsageInBytes);
        }
        ...
        * @opensearch.internal
        */
        public static class CpuStat implements ProtobufWriteable, ToXContentFragment {
            ...
            */
            ...
            CpuStat(final CodedInputStream in) throws IOException {
                numberOfElapsedPeriods = in.readInt64();
                numberOfTimesThrottled = in.readInt64();
                timeThrottledNanos = in.readInt64();
            }

            @Override
            public void writeTo(final CodedOutputStream out) throws IOException {
                out.writeInt64NoTag(numberOfElapsedPeriods);
                out.writeInt64NoTag(numberOfTimesThrottled);
                out.writeInt64NoTag(timeThrottledNanos);
            }
