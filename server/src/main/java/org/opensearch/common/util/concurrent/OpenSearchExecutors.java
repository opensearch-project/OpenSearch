...
public class OpenSearchExecutors {
     ...
     * @deprecated - use {@link OpenSearchExecutorsUtils#PROCESSORS_SETTING}.
     */
    @Deprecated
    public static final Setting<Integer> PROCESSORS_SETTING = OpenSearchExecutorsUtils.PROCESSORS_SETTING;
     ...
     * @deprecated - use {@link OpenSearchExecutorsUtils#NODE_PROCESSORS_SETTING}.
     */
    @Deprecated
    public static final Setting<Integer> NODE_PROCESSORS_SETTING = OpenSearchExecutorsUtils.NODE_PROCESSORS_SETTING;
     ...
     * @deprecated - use {@link OpenSearchExecutorsUtils#allocatedProcessors(Settings)}.
     */
    @Deprecated
    public static int allocatedProcessors(final Settings settings) {
        return OpenSearchExecutorsUtils.allocatedProcessors(settings);
    }
