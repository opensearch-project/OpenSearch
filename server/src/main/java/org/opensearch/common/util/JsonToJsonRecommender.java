...
/**
 * JsonToJsonRecommender provides utilities for analyzing and mapping JSON
 * structures.
 * It builds inverted indices from JSON data and correlates input fields to
 * output fields based on value matches, generating detailed field mappings and
 * JSONPath
 * suggestions.
 *
 * <p>
 * This utility class helps in understanding the transformation relationships
 * between input and output JSON structures by:
 * <ul>
 * <li>Creating inverted indices of JSON values to their paths</li>
 * <li>Generating detailed field-to-field mappings</li>
 * <li>Providing generalized JSONPath transformation suggestions</li>
 * <li>Handling complex nested structures and arrays intelligently</li>
 * </ul>
 *
 * <p>
 * All methods in this class are static as it serves as a utility class.
 * The class is designed to be thread-safe when used properly.
 */
public class JsonToJsonRecommender {
    ...
    /**
     * Generates mapping data with default settings (no detailed output).
