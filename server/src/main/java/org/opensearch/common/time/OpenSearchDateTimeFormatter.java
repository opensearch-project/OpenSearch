 ...
 */
public class OpenSearchDateTimeFormatter {
    ...
    public OpenSearchDateTimeFormatter withChronology(Chronology chrono) {
        return new OpenSearchDateTimeFormatter(getFormatter().withChronology(chrono));
    }
