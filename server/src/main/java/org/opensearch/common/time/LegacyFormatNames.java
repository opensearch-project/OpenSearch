...
/**
 * Legacy Date format names.
 *
 * These format names are to ensure BWC support for camel case DateFormat names on indexes
 * created prior to 2.12.
 *
 * @opensearch.internal
 */
enum LegacyFormatNames {
