...
class JavaDateFormatter implements DateFormatter {
    ...
    private final OpenSearchDateTimeFormatter printer;
    ...
    JavaDateFormatter(
        String format,
        String printFormat,
        OpenSearchDateTimeFormatter printer,
    ...
    JavaDateFormatter(String format, OpenSearchDateTimeFormatter printer, OpenSearchDateTimeFormatter... parsers) {
    ...
    public static DateFormatter combined(
        ...
        OpenSearchDateTimeFormatter printer = javaPrintFormatter.getPrinter();
    ...
    OpenSearchDateTimeFormatter getPrinter() {
        return printer;
    }
