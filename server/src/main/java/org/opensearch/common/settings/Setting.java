...
public class Setting<T> implements ToXContentObject {
    ...
    private static class GroupSetting extends Setting<Settings> {
        ...
        private GroupSetting(
                String key,
                @Nullable Setting<Settings> fallbackSetting,
                Consumer<Settings> validator,
                Property... properties) {
            super(
                new GroupKey(key),
    ...
    public static Setting<Settings> groupSetting(String key, Property... properties) {
        return groupSetting(key, null, (s) -> {}, properties);
    }

    public static Setting<Settings> groupSetting(String key, Setting<Settings> fallbackSettings, Property... properties) {
        return groupSetting(key, fallbackSettings, (s) -> {}, properties);
    }

    public static Setting<Settings> groupSetting(String key, Consumer<Settings> validator, Property... properties) {
        return groupSetting(key, null, validator, properties);
    }

    public static Setting<Settings> groupSetting(String key, Setting<Settings> fallbackSettings, Consumer<Settings> validator, Property... properties) {
        return new GroupSetting(key, fallbackSettings, validator, properties);
    }
