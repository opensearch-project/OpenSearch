    ...
    public static Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Collections.unmodifiableSet(
        new HashSet<>(
            Arrays.asList(
                ...
                SearchTaskSettings.SETTING_TOTAL_NATIVE_MEMORY_BYTES_THRESHOLD,
                SearchTaskSettings.SETTING_NATIVE_MEMORY_BYTES_THRESHOLD,
                ...
                SearchShardTaskSettings.SETTING_NATIVE_MEMORY_BYTES_THRESHOLD,
