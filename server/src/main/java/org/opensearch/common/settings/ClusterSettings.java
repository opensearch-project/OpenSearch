    ...
    public static Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Collections.unmodifiableSet(
        new HashSet<>(
            Arrays.asList(
                ...
                FileCacheThresholdSettings.CLUSTER_ROUTING_ALLOCATION_FILECACHE_INDEX_THRESHOLD_SETTING,
                FileCacheThresholdSettings.CLUSTER_ROUTING_ALLOCATION_FILECACHE_SEARCH_THRESHOLD_SETTING,
