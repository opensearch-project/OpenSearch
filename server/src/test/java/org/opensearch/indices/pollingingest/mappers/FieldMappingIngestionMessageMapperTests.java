...
public class FieldMappingIngestionMessageMapperTests extends OpenSearchTestCase {
    ...
    public void testIdFieldNull_AutoGenerates() {
        Map<String, Object> settings = Map.of(FieldMappingIngestionMessageMapper.ID_FIELD, "user_id");
        FieldMappingIngestionMessageMapper mapper = new FieldMappingIngestionMessageMapper(settings);

        ShardUpdateMessage result = mapMessage(mapper, "{\"user_id\": null, \"name\": \"alice\"}");
    ...
    public void testIdFieldEmptyString_AutoGenerates() {
        Map<String, Object> settings = Map.of(FieldMappingIngestionMessageMapper.ID_FIELD, "user_id");
        FieldMappingIngestionMessageMapper mapper = new FieldMappingIngestionMessageMapper(settings);

        ShardUpdateMessage result = mapMessage(mapper, "{\"user_id\": \"\", \"name\": \"alice\"}");
    ...
    public void testVersionFieldMissing_NoVersion() {
        ...
        Map<String, Object> payloadMap = result.parsedPayloadMap();
        assertFalse(payloadMap.containsKey("_version"));
    }
