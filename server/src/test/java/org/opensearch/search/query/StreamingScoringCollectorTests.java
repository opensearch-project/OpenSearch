...
public class StreamingScoringCollectorTests extends OpenSearchTestCase {
    ...
    public void testStreamingScoringCollector() throws Exception {
        ...
        TopScoreDocCollector delegate = new org.apache.lucene.search.TopScoreDocCollectorManager(10, null, Integer.MAX_VALUE).newCollector();
        StreamingScoringConfig scoringConfig = StreamingScoringConfig.forMode(StreamingScoringMode.CONFIDENCE_BASED);
        ...
        StreamingScoringCollector collector = new StreamingScoringCollector(
            delegate,
            scoringConfig,
            boundProvider,
            frame -> {
    ...
    public void testTextBoundProvider() {
        ...
        BoundProvider.SearchContext context = new BoundProvider.SearchContext() {
            @Override
            public int getDocCount() { return 100; }
            ...
            public org.apache.lucene.search.TopDocs getTopDocs() { 
                ...
                return new org.apache.lucene.search.TopDocs(new org.apache.lucene.search.TotalHits(100, org.apache.lucene.search.TotalHits.Relation.EQUAL_TO), scoreDocs);
            }
            
            @Override
            public float getKthScore() { return 0.5f; }
            
            @Override
            public float getMaxPossibleScore() { return 1.0f; }
