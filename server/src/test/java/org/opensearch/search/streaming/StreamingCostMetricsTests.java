...
public class StreamingCostMetricsTests extends OpenSearchTestCase {
    ...
    public void testCombineWithSubAggregation() {
        StreamingCostMetrics parent = new StreamingCostMetrics(true, 100, 500, 5000);
        StreamingCostMetrics sub = new StreamingCostMetrics(true, 50, 200, 3000);
    ...
    public void testCombineWithSibling() {
        StreamingCostMetrics sibling1 = new StreamingCostMetrics(true, 100, 500, 5000);
        StreamingCostMetrics sibling2 = new StreamingCostMetrics(true, 200, 300, 7000);
    ...
    public void testCombineNonStreamableWithStreamable() {
        StreamingCostMetrics streamable = new StreamingCostMetrics(true, 100, 500, 5000);
        StreamingCostMetrics nonStreamable = new StreamingCostMetrics(false, 0, 0, 0);
