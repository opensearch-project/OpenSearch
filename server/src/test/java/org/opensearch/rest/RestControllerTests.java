...
public class RestControllerTests extends OpenSearchTestCase {
    ...
    public void setup() {
        ...
        restController = new RestController(Collections.emptySet(), null, client, circuitBreakerService, usageService, null);
    ...
    public void testApplyRelevantHeaders() throws Exception {
        ...
        final RestController restController = new RestController(headers, null, null, circuitBreakerService, usageService, null);
    ...
    public void testRequestWithDisallowedMultiValuedHeaderButSameValues() {
        ...
        final RestController restController = new RestController(headers, null, client, circuitBreakerService, usageService, null);
        Map<String, List<String>> restHeaders = new HashMap<>();
        restHeaders.put("header.1", Collections.singletonList("boo"));
    ...
    public void testRegisterSecondMethodWithDifferentNamedWildcard() {
        final RestController restController = new RestController(null, null, null, circuitBreakerService, usageService, null);
    ...
    public void testRestHandlerWrapper() throws Exception {
        ...
        }, client, circuitBreakerService, usageService, null);
    ...
    public void testDispatchRequiresContentTypeForRequestsWithContent() {
        ...
        restController = new RestController(Collections.emptySet(), null, null, circuitBreakerService, usageService, null);
        restController.registerHandler(
            RestRequest.Method.GET,
            "/",
