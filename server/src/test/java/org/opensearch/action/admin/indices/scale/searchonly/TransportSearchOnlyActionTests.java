...
public class TransportSearchOnlyActionTests extends OpenSearchTestCase {
    ...
    public void testAddBlockClusterStateUpdateTaskExecute() {
        ...
        boolean hasBlockWithCorrectId = indexBlocks.stream()
            .anyMatch(block -> block.id() == TransportSearchOnlyAction.INDEX_SEARCHONLY_BLOCK_ID);
        assertTrue("Should find a block with ID " + TransportSearchOnlyAction.INDEX_SEARCHONLY_BLOCK_ID, hasBlockWithCorrectId);
