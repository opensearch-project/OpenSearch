...
public class ClusterHealthResponsesTests extends AbstractSerializingTestCase<ClusterHealthResponse> {
    ...
    public void testVersionCompatibleSerialization() throws IOException {
        ...
        BytesStreamOutput out_lt_7_0 = new BytesStreamOutput();
        Version old_version = VersionUtils.randomVersionBetween(random(), Version.V_6_0_0, Version.V_6_8_0);
        out_lt_7_0.setVersion(old_version);
        clusterHealth.writeTo(out_lt_7_0);

        BytesStreamOutput out_gt_7_0 = new BytesStreamOutput();
        Version new_version = VersionUtils.randomVersionBetween(random(), Version.V_7_0_0, Version.CURRENT);
        out_gt_7_0.setVersion(new_version);
        clusterHealth.writeTo(out_gt_7_0);

        //The serialized output byte stream will not be same; and different by a boolean field "discovered_master"
        assertNotEquals(out_lt_7_0.size(), out_gt_7_0.size());
        assertThat(out_gt_7_0.size() - out_lt_7_0.size(), Matchers.equalTo(1));
        ...
        StreamInput in_lt_6_8 = out_lt_7_0.bytes().streamInput();
        ...
        StreamInput in_gt_7_0 = out_gt_7_0.bytes().streamInput();
