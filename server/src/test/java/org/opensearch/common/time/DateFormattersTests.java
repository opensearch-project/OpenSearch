...
public class DateFormattersTests extends OpenSearchTestCase {
    ...
    public void testEpochMilliParsersWithDifferentFormatters() {
        ...
        {
            DateFormatter formatter = DateFormatter.forPattern("rfc3339||epoch_millis");
            TemporalAccessor accessor = formatter.parse("123");
            assertThat(DateFormatters.from(accessor).toInstant().toEpochMilli(), is(123L));
            assertThat(formatter.pattern(), is("rfc3339||epoch_millis"));
        }
    }
    ...
    public void testEqualsAndHashcode() {
        ...
        DateFormatter rfc339Formatter = DateFormatters.forPattern("rfc3339");
        assertThat(rfc339Formatter.hashCode(), is(DateFormatters.forPattern("rfc3339").hashCode()));
        assertThat(rfc339Formatter, sameInstance(DateFormatters.forPattern("rfc3339")));
        assertThat(rfc339Formatter, equalTo(DateFormatters.forPattern("rfc3339")));
    }
    ...
    public void testRFC339Parsing() {
        DateFormatter formatter = DateFormatters.forPattern("rfc3339");
        ...
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("abc"));
        assertThat(e.getMessage(), is("failed to parse date field [abc] with format [rfc3339]"));
        // Invalid offset
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:27:39-00:00"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:27:39-00:00] with format [rfc3339]"));
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:27:39.+00:00"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:27:39.+00:00] with format [rfc3339]"));
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:27:39_00:00"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:27:39_00:00] with format [rfc3339]"));
        // No offset
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:27:39"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:27:39] with format [rfc3339]"));
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:27:39.123"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:27:39.123] with format [rfc3339]"));
        // No end of fraction
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:27:39.123"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:27:39.123] with format [rfc3339]"));
        // Invalid fraction
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:27:39.abcZ"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:27:39.abcZ] with format [rfc3339]"));
        // Invalid date
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("201702-21T15:27:39.123456+0000"));
        assertThat(e.getMessage(), is("failed to parse date field [201702-21T15:27:39.123456+0000] with format [rfc3339]"));
        // More than 9 digits of nanosecond resolution
        e = expectThrows(IllegalArgumentException.class, () -> formatter.parse("2017-02-21T15:00:00.1234567891Z"));
        assertThat(e.getMessage(), is("failed to parse date field [2017-02-21T15:00:00.1234567891Z] with format [rfc3339]"));
    }

    public void testRFC3339ParserWithDifferentFormatters() {
        {
            DateFormatter formatter = DateFormatter.forPattern("strict_date_optional_time||rfc3339");
            ...
            assertThat(formatter.pattern(), is("strict_date_optional_time||rfc3339"));
        }

        {
            DateFormatter formatter = DateFormatter.forPattern("rfc3339||strict_date_optional_time");
            ...
            assertThat(formatter.pattern(), is("rfc3339||strict_date_optional_time"));
        }
    ...
    public void testRFC3339ParserAgainstDifferentFormatters() {
        DateFormatter rfc3339Formatter = DateFormatter.forPattern("rfc3339");
        {
