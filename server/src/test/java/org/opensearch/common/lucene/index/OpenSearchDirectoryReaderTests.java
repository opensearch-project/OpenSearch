...
public class OpenSearchDirectoryReaderTests extends OpenSearchTestCase {
    ...
    public void testCriteriaBasedReaders() throws IOException {
        try (Directory dir1 = newDirectory(); Directory dir2 = newDirectory(); Directory dir3 = newDirectory()) {
            ...
            assertTrue(reader1.getDelegate() instanceof OpenSearchDirectoryReader.CriteriaBasedReader);
            OpenSearchDirectoryReader.CriteriaBasedReader cbr1 = (OpenSearchDirectoryReader.CriteriaBasedReader) reader1.getDelegate();
            ...
            assertTrue(reader2.getDelegate() instanceof OpenSearchDirectoryReader.CriteriaBasedReader);
            OpenSearchDirectoryReader.CriteriaBasedReader cbr2 = (OpenSearchDirectoryReader.CriteriaBasedReader) reader2.getDelegate();
