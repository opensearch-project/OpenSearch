...
public class TranslogHeaderTests extends OpenSearchTestCase {
    ...
    public void testLegacyTranslogVersions() throws Exception {
        ...
        checkFailsToOpen("/org/opensearch/index/translog/translog-v1-corrupted-magic.binary",
            TranslogCorruptedException.class, "translog looks like version 1 or later, but has corrupted header");
        checkFailsToOpen("/org/opensearch/index/translog/translog-v1-corrupted-body.binary",
