...
public class RemoteSegmentStoreDirectoryTests extends BaseRemoteSegmentStoreDirectoryTests {
    ...
    public void testGetPinnedTimestampLockedFilesWithPinnedTimestamps() {
        ...
        Map<Long, String> pinnedTimestampToMetadataMap = remoteSegmentStoreDirectory.getMetadataFilePinnedTimestampMap();
        assertEquals(0, pinnedTimestampToMetadataMap.size());
        ...
        pinnedTimestampToMetadataMap = remoteSegmentStoreDirectory.getMetadataFilePinnedTimestampMap();
        ...
        assertEquals(1, pinnedTimestampToMetadataMap.size());
        assertEquals(metadataFiles.get(1000L), pinnedTimestampToMetadataMap.get(1000L));
        ...
        pinnedTimestampToMetadataMap = remoteSegmentStoreDirectory.getMetadataFilePinnedTimestampMap();
        // Now we cache all the matches except the last one.
        assertEquals(2, pinnedTimestampToMetadataMap.size());
        assertEquals(metadataFiles.get(1000L), pinnedTimestampToMetadataMap.get(1000L));
        assertEquals(metadataFiles.get(1900L), pinnedTimestampToMetadataMap.get(2000L));
        ...
        pinnedTimestampToMetadataMap = remoteSegmentStoreDirectory.getMetadataFilePinnedTimestampMap();
        // Now we cache all the matches except the last one.
        assertEquals(4, pinnedTimestampToMetadataMap.size());
        assertEquals(metadataFiles.get(1900L), pinnedTimestampToMetadataMap.get(2000L));
        assertEquals(metadataFiles.get(3000L), pinnedTimestampToMetadataMap.get(3000L));
        assertEquals(metadataFiles.get(3001L), pinnedTimestampToMetadataMap.get(4000L));
        assertEquals(metadataFiles.get(3001L), pinnedTimestampToMetadataMap.get(5000L));
