...
public class FloatNestedSortingTests extends DoubleNestedSortingTests {
    ...
    protected void assertAvgScoreMode(Query parentFilter, IndexSearcher searcher,
        ...
        Assert.assertThat(topDocs.totalHits.value, equalTo(7L));
        Assert.assertThat(topDocs.scoreDocs.length, equalTo(5));
        Assert.assertThat(topDocs.scoreDocs[0].doc, equalTo(11));
        Assert.assertThat(((Number) ((FieldDoc) topDocs.scoreDocs[0]).fields[0]).intValue(), equalTo(2));
        Assert.assertThat(topDocs.scoreDocs[1].doc, equalTo(7));
        Assert.assertThat(((Number) ((FieldDoc) topDocs.scoreDocs[1]).fields[0]).intValue(), equalTo(2));
        Assert.assertThat(topDocs.scoreDocs[2].doc, equalTo(3));
        Assert.assertThat(((Number) ((FieldDoc) topDocs.scoreDocs[2]).fields[0]).intValue(), equalTo(3));
        Assert.assertThat(topDocs.scoreDocs[3].doc, equalTo(15));
        Assert.assertThat(((Number) ((FieldDoc) topDocs.scoreDocs[3]).fields[0]).intValue(), equalTo(3));
        Assert.assertThat(topDocs.scoreDocs[4].doc, equalTo(19));
        Assert.assertThat(((Number) ((FieldDoc) topDocs.scoreDocs[4]).fields[0]).intValue(), equalTo(3));
    }
