...
public class NestedSortingTests extends AbstractFieldDataTestCase {
    ...
    public void testMultiLevelNestedSorting() throws IOException {
        ...
        List<List<Document>> books = new ArrayList<>();
        {
            ...
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 743));
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 234));
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 478));
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 849));
        ...
        }
        {
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 76));
        ...
        }
        {
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 976));
        ...
        }
        {
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 180));
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 150));
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 120));
            ...
            document.add(new StringField(NestedPathFieldMapper.NAME, "chapters.paragraphs", Field.Store.NO));
            document.add(new TextField("chapters.paragraphs.text", "some text...", Field.Store.NO));
            document.add(SortedNumericDocValuesField.indexedField("chapters.paragraphs.word_count", 87));
