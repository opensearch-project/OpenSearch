...
public class FieldTypeLookupTests extends OpenSearchTestCase {
    ...
    public void testAddFieldCorrelation() {
        ...
        MappedFieldType aliasType = lookup.get("correlation");
    ...
    public void testSimpleMatchToFullName() {
        ...
        FieldCorrelationMapper correlation1 = new FieldCorrelationMapper("food_relation", "food_relation", "foo", "schema", "barFK");
        FieldCorrelationMapper correlation2 = new FieldCorrelationMapper("barometer_relation", "barometer_relation", "bar", "schema", "barFK");

        FieldTypeLookup lookup = new FieldTypeLookup(
            Arrays.asList(field1, field2),
            Arrays.asList(alias1, alias2),
            Arrays.asList(correlation1, correlation2)
        );
        ...
        assertFalse(names.contains("food_relation"));

        assertTrue(names.contains("bar"));
        assertTrue(names.contains("barometer"));
        assertTrue(names.contains("barometer_relation"));
    }
