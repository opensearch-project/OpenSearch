...
public class ContextAwareGroupingFieldMapperTests extends OpenSearchTestCase {
    ...
    public void testValidFieldsMapping() throws Exception {
        ...
        ContextAwareGroupingFieldMapper.Builder builder = (ContextAwareGroupingFieldMapper.Builder) ContextAwareGroupingFieldMapper.PARSER
            .parse("context-aware-grouping", node, mockParserContext, mockObjectMapperBuilder);
        ...
        assertEquals("context-aware-grouping", mapper.simpleName());
    ...
    public void testInvalidFieldsType() {
        ...
        MapperParsingException e = expectThrows(
            ...
            () -> ContextAwareGroupingFieldMapper.PARSER.parse("context-aware-grouping", node1, mockParserContext, mockObjectMapperBuilder)
        );
        ...
        e = expectThrows(
            MapperParsingException.class,
            () -> ContextAwareGroupingFieldMapper.PARSER.parse("context-aware-grouping", node2, mockParserContext, mockObjectMapperBuilder)
        );
        assertTrue(e.getMessage().contains("Currently [fields] in context-aware-grouping does not support multiple values"));
        ...
        assertTrue(e.getMessage().contains("[fields] in context-aware-grouping is required"));
        ...
        e = expectThrows(
            MapperParsingException.class,
            () -> ContextAwareGroupingFieldMapper.PARSER.parse("context-aware-grouping", node, mockParserContext, mockObjectMapperBuilder)
        );
    }
    ...
    public void testIngestAttemptThrowsException() {
        ...
        ContextAwareGroupingFieldMapper mapper = new ContextAwareGroupingFieldMapper(
            "context-aware-grouping",
            fieldType,
            new ContextAwareGroupingFieldMapper.Builder("context-aware-grouping")
        );
        ...
        assertTrue(e.getMessage().contains("context-aware-grouping cannot be ingested in the document"));
    }
}
