...
public class NumberFieldMapperTests extends AbstractNumericFieldMapperTestCase {
    ...
    public void testOutOfRangeValues() throws IOException {
        final List<NumberFieldTypeTests.OutOfRangeSpec> inputs = Arrays.asList(
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.BYTE, "128", "is out of range for a byte"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.SHORT, "32768", "is out of range for a short"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.INTEGER, "2147483648", "is out of range for an integer"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.LONG, "9223372036854775808", "out of range for a long"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.LONG, "1e999999999", "out of range for a long"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.BYTE, "-129", "is out of range for a byte"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.SHORT, "-32769", "is out of range for a short"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.INTEGER, "-2147483649", "is out of range for an integer"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.LONG, "-9223372036854775809", "out of range for a long"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.LONG, "-1e999999999", "out of range for a long"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.BYTE, 128, "is out of range for a byte"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.SHORT, 32768, "out of range of Java short"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.INTEGER, 2147483648L, " out of range of int"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.LONG, new BigInteger("9223372036854775808"), "out of range of long"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.BYTE, -129, "is out of range for a byte"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.SHORT, -32769, "out of range of Java short"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.INTEGER, -2147483649L, " out of range of int"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.LONG, new BigInteger("-9223372036854775809"), "out of range of long"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.HALF_FLOAT, "65520", "[half_float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.FLOAT, "3.4028235E39", "[float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.DOUBLE, "1.7976931348623157E309", "[double] supports only finite values"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.HALF_FLOAT, "-65520", "[half_float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.FLOAT, "-3.4028235E39", "[float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.DOUBLE, "-1.7976931348623157E309", "[double] supports only finite values"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.HALF_FLOAT, Float.NaN, "[half_float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.FLOAT, Float.NaN, "[float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.DOUBLE, Double.NaN, "[double] supports only finite values"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.HALF_FLOAT, Float.POSITIVE_INFINITY, "[half_float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.FLOAT, Float.POSITIVE_INFINITY, "[float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.DOUBLE, Double.POSITIVE_INFINITY, "[double] supports only finite values"),

            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.HALF_FLOAT, Float.NEGATIVE_INFINITY, "[half_float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.FLOAT, Float.NEGATIVE_INFINITY, "[float] supports only finite values"),
            NumberFieldTypeTests.OutOfRangeSpec.of(NumberType.DOUBLE, Double.NEGATIVE_INFINITY, "[double] supports only finite values")
        );

        for(NumberFieldTypeTests.OutOfRangeSpec item: inputs) {
