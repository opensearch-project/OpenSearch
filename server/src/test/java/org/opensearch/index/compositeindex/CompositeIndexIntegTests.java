...
public class CompositeIndexIntegTests extends OpenSearchIntegTestCase {
    ...
    public void testInvalidCompositeIndex() {
        ...
        assertEquals(
            "dimension field [timestamp] with field type [date] is not same as the source field type for composite field [my_field]",
            ex.getMessage()
        );
