...
public class RemoteStoreEnumsTests extends OpenSearchTestCase {
    ...
    public void testGeneratePathForFixedType() {
        ...
        // Translog Metadata
        dataType = METADATA;
        pathInput = RemoteStorePathInput.builder()
            .basePath(blobPath)
            .indexUUID(indexUUID)
            .shardId(shardId)
            .dataCategory(dataCategory)
        ...
        dataType = LOCK_FILES;
        RemoteStorePathInput finalPathInput = RemoteStorePathInput.builder()
            .basePath(blobPath)
            .indexUUID(indexUUID)
            .shardId(shardId)
            .dataCategory(dataCategory)
    ...
    private String derivePath(String basePath, RemoteStorePathInput pathInput) {
