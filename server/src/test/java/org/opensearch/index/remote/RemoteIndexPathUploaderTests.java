...
public class RemoteIndexPathUploaderTests extends OpenSearchTestCase {
    ...
    public void testInterceptWithNoRemoteDataAttributes() throws IOException {
        ...
        remoteIndexPathUploader.interceptIndexCreation(indexMetadataList, actionListener);
    ...
    public void testInterceptWithEmptyIndexMetadataList() throws IOException {
        ...
        remoteIndexPathUploader.interceptIndexCreation(Collections.emptyList(), actionListener);
        assertEquals(1, successCount.get());
        assertEquals(0, failureCount.get());
    }
