...
public class CombinedFieldsQueryBuilderTests extends AbstractQueryTestCase<CombinedFieldsQueryBuilder> {
    ...
    protected void doAssertLuceneQuery(CombinedFieldsQueryBuilder queryBuilder, Query query, QueryShardContext context) {
        ...
        assertThat("Query should be of expected type", query, anyOf(
    ...
    public void testMultipleFieldsWithBoosts() {
        ...
        CombinedFieldsQueryBuilder queryBuilder = new CombinedFieldsQueryBuilder(queryText, "title",
         "content^2.0", "summary^0.5", "tags^1.5");
    ...
    public void testOrOperatorQueryGeneration() throws IOException {
        ...
        booleanQuery.clauses().forEach(clause -> {
            assertEquals("All clauses should be SHOULD for OR operator", 
                BooleanClause.Occur.SHOULD, clause.occur());
        });
        
        assertThat("Should have clauses for multi-term query", 
            booleanQuery.clauses().size(), notNullValue());
    }
    ...
    public void testBoostConfiguration() {
        ...
        assertThat("Exception message should mention negative boost", 
            exception.getMessage(), containsString("negative [boost]"));
    }
    ...
    public void testJsonSerializationWithMultipleFields() throws IOException {
        ...
        Map<String, Float> expectedFieldToWeight = Map.of(
            "title", 2.0f,
            "content", 1.5f,
            "tags", 0.8f,
            "metadata", 1.2f
    ...
    public void testOperatorBehaviorFunctional() throws IOException {
        ...
        CombinedFieldsQueryBuilder andQuery = new CombinedFieldsQueryBuilder("machine learning", "content")
            .operator(Operator.AND);
        ...
        CombinedFieldsQueryBuilder orQuery = new CombinedFieldsQueryBuilder("machine learning", "content")
            .operator(Operator.OR);
    ...
    public void testConstructorValidation() {
        IllegalArgumentException nullValueException = expectThrows(IllegalArgumentException.class,
            () -> new CombinedFieldsQueryBuilder(null, "content"));
        assertThat("Exception should mention query value", 
            nullValueException.getMessage(), containsString("requires query value"));
        
        IllegalArgumentException nullFieldsException = expectThrows(IllegalArgumentException.class,
            () -> new CombinedFieldsQueryBuilder("test", (String[]) null));
        assertThat("Exception should mention field list", 
            nullFieldsException.getMessage(), containsString("requires field list"));
    }
    ...
    public void testNonTextFieldRejection() throws IOException {
        ...
        assertThat("Exception should mention field type support", 
            exception.getMessage(), containsString("does not support [combined_fields] queries"));
    }
    ...
    public void testFieldBoostValidation() {
        ...
        assertThat("Exception should mention invalid input", 
            exception.getMessage(), containsString("invalid"));
    }
    ...
    public void testUnmappedFieldsHandling() throws IOException {
        ...
        Query query = queryBuilder.toQuery(createShardContext());
        assertThat("Query should be MatchNoDocsQuery for unmapped fields", 
    ...
    public void testPhraseQueryHandling() throws IOException {
        ...
        try {
            ...
            assertThat("Exception should mention phrase support", 
                e.getMessage(), containsString("phrases"));
        }
    }
