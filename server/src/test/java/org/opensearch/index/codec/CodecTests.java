...
public class CodecTests extends OpenSearchTestCase {
    ...
    public void testResolveDefaultCodecs() throws Exception {
        ...
        assertThat(codecService.codec("default"), instanceOf(Lucene100Codec.class));
    }

    public void testDefault() throws Exception {
        Codec codec = createCodecService(false).codec("default");
        assertStoredFieldsCompressionEquals(Lucene100Codec.Mode.BEST_SPEED, codec);
    }

    public void testDefaultWithCompositeIndex() throws Exception {
        Codec codec = createCodecService(false, true).codec("default");
        assertStoredFieldsCompressionEquals(Lucene100Codec.Mode.BEST_SPEED, codec);
        assert codec instanceof Composite912Codec;
    }

    public void testBestCompression() throws Exception {
        Codec codec = createCodecService(false).codec("best_compression");
        assertStoredFieldsCompressionEquals(Lucene100Codec.Mode.BEST_COMPRESSION, codec);
    }
    ...
    public void testResolveDefaultCodecsWithCompositeIndex() throws Exception {
        ...
        assertThat(codecService.codec("default"), instanceOf(Composite912Codec.class));
    }
    ...
    private void assertStoredFieldsCompressionEquals(Lucene100Codec.Mode expected, Codec actual) throws Exception {
        SegmentReader sr = getSegmentReader(actual);
        String v = sr.getSegmentInfo().info.getAttribute(Lucene90StoredFieldsFormat.MODE_KEY);
        assertNotNull(v);
        assertEquals(expected, Lucene100Codec.Mode.valueOf(v));
    }
