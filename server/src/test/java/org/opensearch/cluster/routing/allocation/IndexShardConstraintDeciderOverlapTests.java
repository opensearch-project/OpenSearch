...
public class IndexShardConstraintDeciderOverlapTests extends OpenSearchAllocationWithConstraintsTestCase {
    ...
    public void testNodeVersionCompatibilityOverlap() {
        ...
        buildAllocationService(AllocationConstraints.ConstraintMode.UNASSIGNED, "node_0");
    ...
    public void testZoneBalanced() {
        ...
        buildZoneAwareAllocationService(AllocationConstraints.ConstraintMode.NONE);
        allocateAndCheckIndexShardHotSpots(false, 6);

        resetCluster();
        buildZoneAwareAllocationService(AllocationConstraints.ConstraintMode.UNASSIGNED);
        allocateAndCheckIndexShardHotSpots(false, 6);
    }
