...
public class MetadataMappingServiceTests extends OpenSearchSingleNodeTestCase {
    ...
    public void testMappingClusterStateUpdateDoesntChangeExistingIndices() throws Exception {
        ...
        final CompressedXContent currentMapping = indexService.mapperService()
            .documentMapper(MapperService.SINGLE_MAPPING_NAME)
            .mappingSource();
        ...
        assertThat(
            indexService.mapperService().documentMapper(MapperService.SINGLE_MAPPING_NAME).mappingSource(),
        ...
        assertThat(indexService.mapperService().documentMapper(MapperService.SINGLE_MAPPING_NAME).mappingSource(), equalTo(currentMapping));
    }
