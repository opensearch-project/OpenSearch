...
public class ShortestRunningTaskFirstStrategySelectionStrategyTests extends OpenSearchTestCase {
    public void testSortingCondition() {
        ...
        tasks.sort(new ShortestRunningTaskFirstSelectionStrategy().sortingCondition());
