...
public class ScalingThreadPoolTests extends OpenSearchThreadPoolTestCase {
    ...
    private int expectedSize(final String threadPoolName, final int numberOfProcessors) {
        ...
        sizes.put(ThreadPool.Names.REMOTE_UPLOAD, ThreadPool::halfAllocatedProcessorsMaxTen);
        sizes.put(ThreadPool.Names.PRIORITY_REMOTE_UPLOAD, ThreadPool::halfAllocatedProcessorsMaxTen);
