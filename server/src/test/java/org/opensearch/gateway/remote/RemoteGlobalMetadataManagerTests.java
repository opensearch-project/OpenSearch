...
public class RemoteGlobalMetadataManagerTests extends OpenSearchTestCase {
    ...
    public void setup() {
        ...
        RemoteClusterStateBlobStore<CoordinationMetadata, RemoteCoordinationMetadata> remoteCoordinationStore =
            new RemoteClusterStateBlobStore<>(blobStoreTransferService, blobStoreRepository, "test-cluster", threadPool, GENERIC);
        ...
        remoteGlobalMetadataManager = new RemoteGlobalMetadataManager(
            clusterSettings,
            remoteGlobalMetadataStore,
            remoteCoordinationStore,
            remoteSettingStore,
            remoteTemplateStore,
            remoteCustomStore,
            new NoneCompressor(),
