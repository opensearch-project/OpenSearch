...
public class SegmentReplicationWithNoOpIT extends OpenSearchIntegTestCase {
    ...
    public void testReplicationAfterPrimaryRefreshAndFlush() throws Exception {
        ...
        String clusterUuid = client().admin().cluster().prepareState().execute().get().getState().getMetadata().clusterUUID();

        assertAcked(
            client().admin()
                .cluster()
                .preparePutRepository(clusterUuid)
                .setType("fs")
