...
public class SimpleNodesInfoIT extends OpenSearchIntegTestCase {
    ...
    public void testAllocatedProcessors() throws Exception {
        List<String> nodesIds = internalCluster().startNodes(
            Settings.builder().put(OpenSearchExecutorsUtils.NODE_PROCESSORS_SETTING.getKey(), 3).build(),
            Settings.builder().put(OpenSearchExecutorsUtils.NODE_PROCESSORS_SETTING.getKey(), 6).build()
        );
