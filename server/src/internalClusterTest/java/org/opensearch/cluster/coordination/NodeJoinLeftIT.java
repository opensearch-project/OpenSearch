...
public class NodeJoinLeftIT extends OpenSearchIntegTestCase {
    ...
    public void testClusterStabilityWhenClusterStatePublicationLagsOnShardCleanup() throws Exception {
        setupClusterForPublicationLagTest();
        try {
            ...
            assertFalse("Cluster health was never red", clusterHealthResponse.isTimedOut());
            boolean logFound;
    ...
    public void testClusterStabilityWhenClusterStatePublicationLagsWithLongRunningListenerOnApplierThread() throws Exception {
        ...
        Map<ClusterApplierService, ClusterStateListener> clusterApplierServiceClusterListenerMap = setUpClusterForLongRunningApplier(
            dataNodeClusterApplierService
        );
    ...
    private Map<ClusterApplierService, ClusterStateListener> setUpClusterForLongRunningApplier(
        List<ClusterApplierService> dataNodeClusterApplierService
    ) {
        ...
        dataNodeClusterApplierService.forEach(dataNodeClusterApplierServiceInstance -> {
            ClusterStateListener clusterStateListener = event -> {
        ...
        return clusterApplierServiceClusterListenerMap;
    }

    private void setupClusterForPublicationLagTest() {
