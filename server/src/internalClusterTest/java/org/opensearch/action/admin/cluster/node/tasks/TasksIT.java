...
public class TasksIT extends AbstractTasksIT {
    ...
    public void testSearchTaskDescriptions() {
        ...
        // Add traceId to the header. This is explicitly not allowed to be passed from outside, but for this test we add this to verify its
        // correct internal propagation.
