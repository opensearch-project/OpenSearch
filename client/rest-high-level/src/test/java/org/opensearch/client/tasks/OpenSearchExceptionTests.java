...
public class OpenSearchExceptionTests extends AbstractResponseTestCase<org.elasticsearch.OpenSearchException,
    OpenSearchException> {

    @Override
    protected org.elasticsearch.OpenSearchException createServerTestInstance(XContentType xContentType) {
        ...
        org.elasticsearch.OpenSearchException exception = new org.elasticsearch.OpenSearchException("elastic_exception", iae);
    ...
    @Override
    protected void assertInstances(org.elasticsearch.OpenSearchException serverTestInstance, OpenSearchException clientInstance) {
