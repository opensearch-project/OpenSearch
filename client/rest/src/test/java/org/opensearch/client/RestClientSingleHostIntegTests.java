...
import org.opensearch.client.auth.AnyAuthScope;
...
public class RestClientSingleHostIntegTests extends RestClientTestCase {
    ...
    private RestClient createRestClient(final boolean useAuth, final boolean usePreemptiveAuth) {
        ...
        credentialsProvider.setCredentials(new AnyAuthScope(), new UsernamePasswordCredentials("user", "pass".toCharArray()));
            ...
            restClientBuilder.setHttpClientConfigCallback(new RestClientBuilder.HttpClientConfigCallback() {
                ...
                public HttpAsyncClientBuilder customizeHttpClient(final HttpAsyncClientBuilder httpClientBuilder) {
                    if (usePreemptiveAuth == false) {
                        ...
                        httpClientBuilder.setTargetAuthenticationStrategy(new DefaultAuthenticationStrategy());
                    }
    ...
    private ClassicRequestProducer getRequestProducer(ClassicHttpRequest request, HttpHost host) {
        return ClassicRequestProducer.create(ClassicRequestBuilder.copy(request).setHttpHost(host).build());
