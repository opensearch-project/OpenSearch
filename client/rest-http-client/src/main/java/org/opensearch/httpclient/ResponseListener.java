...
/**
 * Listener to be provided when calling async performRequest methods provided by {@link RestHttpClient}.
 ...
 *
 * <p>
 * Note that it is <strong>not</strong> safe to call {@link RestHttpClient#close()} from either of these
 * callbacks.
 */
