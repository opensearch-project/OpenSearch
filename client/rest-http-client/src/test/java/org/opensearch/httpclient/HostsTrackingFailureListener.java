...
/**
 * {@link RestHttpClient.FailureListener} impl that allows to track when it gets called for which host.
 */
class HostsTrackingFailureListener extends RestHttpClient.FailureListener {
